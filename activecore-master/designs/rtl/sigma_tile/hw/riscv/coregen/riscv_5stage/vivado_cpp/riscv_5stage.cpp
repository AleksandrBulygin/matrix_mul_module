...
void riscv_5stage(ap_uint<1> geninit, hls::stream<ap_uint<8> >& irq_fifo, hls::stream<ap_uint<32> >& genmcopipe_instr_mem_resp, hls::stream<ap_uint<32> >& genmcopipe_data_mem_resp, hls::stream<ap_uint<32> >& genmcopipe_coproc_M_if_resp, hls::stream<ap_uint<32> >& genmcopipe_coproc_custom0_if_resp, hls::stream<genpmodule_riscv_5stage_genmcopipe_instr_mem_genstruct_fifo_wdata>& genmcopipe_instr_mem_req, hls::stream<genpmodule_riscv_5stage_genmcopipe_data_mem_genstruct_fifo_wdata>& genmcopipe_data_mem_req, hls::stream<genpmodule_riscv_5stage_genmcopipe_coproc_M_if_genstruct_fifo_wdata>& genmcopipe_coproc_M_if_req, hls::stream<genpmodule_riscv_5stage_genmcopipe_coproc_custom0_if_genstruct_fifo_wdata>& genmcopipe_coproc_custom0_if_req) {
	...
	ap_uint<32> gen517_cyclix_var [32];
...
gen517_cyclix_var = genpsticky_glbl_regfile;
		// mcopipe processing
		genmcopipe_instr_mem_wr_done = ap_uint<32>(0);
		genmcopipe_instr_mem_rd_done = ap_uint<32>(0);
		...
		gen317_cyclix_var = genpstage_WB_genctrl_stalled_glbl;
		if (gen317_cyclix_var) {
			genpstage_WB_genctrl_new = ap_uint<32>(0);
			genpstage_WB_genctrl_stalled_glbl = ap_uint<32>(0);
			genpstage_WB_genctrl_active = ap_uint<32>(1);
		}
		gen318_cyclix_var = ap_uint<1>(0);
		gen318_cyclix_var = (gen318_cyclix_var || gen317_cyclix_var);
		gen318_cyclix_var = !gen318_cyclix_var;
		...
		gen319_cyclix_var = genpstage_WB_genctrl_occupied;
		if (gen319_cyclix_var) {
			...
			gen320_cyclix_var = genpstage_WB_TRX_BUF[0].genmcopipe_handle_data_mem.rdreq_pending;
			if (gen320_cyclix_var) {
				gen321_cyclix_var = (genpstage_WB_TRX_BUF[0].genmcopipe_handle_data_mem.if_id == ap_uint<1>(0));
				gen322_cyclix_var = gen321_cyclix_var;
				if (gen322_cyclix_var) {
					gen323_cyclix_var = (genpstage_WB_TRX_BUF[0].genmcopipe_handle_data_mem.tid == genmcopipe_data_mem_rd_ptr);
					gen324_cyclix_var = gen323_cyclix_var;
					if (gen324_cyclix_var) {
						gen325_cyclix_var = genmcopipe_data_mem_resp.read_nb(gen436_pipex_mcopipe_rdata);
						gen326_cyclix_var = gen325_cyclix_var;
			...
			gen327_cyclix_var = genpstage_WB_TRX_BUF[0].genmcopipe_handle_coproc_M_if.rdreq_pending;
			if (gen327_cyclix_var) {
				gen328_cyclix_var = (genpstage_WB_TRX_BUF[0].genmcopipe_handle_coproc_M_if.if_id == ap_uint<1>(0));
				gen329_cyclix_var = gen328_cyclix_var;
				if (gen329_cyclix_var) {
					gen330_cyclix_var = (genpstage_WB_TRX_BUF[0].genmcopipe_handle_coproc_M_if.tid == genmcopipe_coproc_M_if_rd_ptr);
					gen331_cyclix_var = gen330_cyclix_var;
					if (gen331_cyclix_var) {
						gen332_cyclix_var = genmcopipe_coproc_M_if_resp.read_nb(gen437_pipex_mcopipe_rdata);
				...
				gen334_cyclix_var = (genpstage_WB_TRX_BUF[0].genmcopipe_handle_coproc_M_if.if_id == ap_uint<1>(1));
				gen335_cyclix_var = gen334_cyclix_var;
				if (gen335_cyclix_var) {
					gen336_cyclix_var = (genpstage_WB_TRX_BUF[0].genmcopipe_handle_coproc_M_if.tid == genmcopipe_coproc_custom0_if_rd_ptr);
					gen337_cyclix_var = gen336_cyclix_var;
					if (gen337_cyclix_var) {
						gen338_cyclix_var = genmcopipe_coproc_custom0_if_resp.read_nb(gen438_pipex_mcopipe_rdata);
			...
			gen340_cyclix_var = genpstage_WB_genpctrl_flushreq;
		...
		if (gen341_cyclix_var) {
			...
			gen342_cyclix_var = gen408_pipex_var;
			if (gen342_cyclix_var) {
				gen343_cyclix_var = genpstage_WB_TRX_BUF[0].genmcopipe_handle_data_mem.resp_done;
				...
				gen344_cyclix_var = gen410_pipex_var;
				...
				gen345_cyclix_var = gen411_pipex_var;
				if (gen345_cyclix_var) {
					gen346_cyclix_var = genpstage_WB_genctrl_active;
		...
		if (gen347_cyclix_var) {
			...
			gen349_cyclix_var = gen418_pipex_var;
		...
		if (gen350_cyclix_var) {
			...
			gen352_cyclix_var = gen426_pipex_var;
		...
		gen353_cyclix_var = gen429_pipex_var;
		...
		gen354_cyclix_var = gen430_pipex_var;
		if (gen354_cyclix_var) {
			gen355_cyclix_var = genpstage_WB_TRX_BUF[0].genmcopipe_handle_coproc_M_if.resp_done;
			...
			gen356_cyclix_var = gen432_pipex_var;
			...
			gen357_cyclix_var = gen433_pipex_var;
			if (gen357_cyclix_var) {
				gen358_cyclix_var = genpstage_WB_genctrl_active;
		...
		gen359_cyclix_var = gen435_pipex_var;
		...
		gen360_cyclix_var = genpstage_WB_genctrl_stalled_glbl;
		if (gen360_cyclix_var) {
			genpstage_WB_genctrl_finish = ap_uint<32>(0);
			genpstage_WB_genctrl_succ = ap_uint<32>(0);
		}
		gen361_cyclix_var = ap_uint<1>(0);
		gen361_cyclix_var = (gen361_cyclix_var || gen360_cyclix_var);
		gen361_cyclix_var = !gen361_cyclix_var;
		...
		gen362_cyclix_var = genpstage_WB_genctrl_finish;
		if (gen362_cyclix_var) {
			// programming next stage in case transaction is able to propagate
			gen363_cyclix_var = genpstage_WB_genctrl_succ;
		...
		gen364_cyclix_var = ~genpstage_WB_TRX_BUF_COUNTER_FULL;
		genpstage_WB_genctrl_rdy = gen364_cyclix_var;
		...
		gen365_cyclix_var = genpstage_MEM_genctrl_stalled_glbl;
		if (gen365_cyclix_var) {
			genpstage_MEM_genctrl_new = ap_uint<32>(0);
			genpstage_MEM_genctrl_stalled_glbl = ap_uint<32>(0);
			genpstage_MEM_genctrl_active = ap_uint<32>(1);
		}
		gen366_cyclix_var = ap_uint<1>(0);
		gen366_cyclix_var = (gen366_cyclix_var || gen365_cyclix_var);
		gen366_cyclix_var = !gen366_cyclix_var;
		...
		gen367_cyclix_var = genpstage_MEM_genctrl_occupied;
		if (gen367_cyclix_var) {
			// Initializing new newaccums descriptors ####
			gen368_cyclix_var = genpstage_MEM_genctrl_new;
			...
			// Acquiring mcopipe rdata
			gen369_cyclix_var = genpstage_MEM_TRX_BUF[0].genmcopipe_handle_data_mem.rdreq_pending;
			if (gen369_cyclix_var) {
				gen370_cyclix_var = (genpstage_MEM_TRX_BUF[0].genmcopipe_handle_data_mem.if_id == ap_uint<1>(0));
				gen371_cyclix_var = gen370_cyclix_var;
				if (gen371_cyclix_var) {
					gen372_cyclix_var = (genpstage_MEM_TRX_BUF[0].genmcopipe_handle_data_mem.tid == genmcopipe_data_mem_rd_ptr);
					gen373_cyclix_var = gen372_cyclix_var;
					if (gen373_cyclix_var) {
						gen374_cyclix_var = genmcopipe_data_mem_resp.read_nb(gen439_pipex_mcopipe_rdata);
			...
			gen376_cyclix_var = genpstage_MEM_TRX_BUF[0].genmcopipe_handle_coproc_M_if.rdreq_pending;
			if (gen376_cyclix_var) {
				gen377_cyclix_var = (genpstage_MEM_TRX_BUF[0].genmcopipe_handle_coproc_M_if.if_id == ap_uint<1>(0));
				gen378_cyclix_var = gen377_cyclix_var;
				if (gen378_cyclix_var) {
					gen379_cyclix_var = (genpstage_MEM_TRX_BUF[0].genmcopipe_handle_coproc_M_if.tid == genmcopipe_coproc_M_if_rd_ptr);
					gen380_cyclix_var = gen379_cyclix_var;
					if (gen380_cyclix_var) {
						gen381_cyclix_var = genmcopipe_coproc_M_if_resp.read_nb(gen440_pipex_mcopipe_rdata);
				...
				gen383_cyclix_var = (genpstage_MEM_TRX_BUF[0].genmcopipe_handle_coproc_M_if.if_id == ap_uint<1>(1));
				gen384_cyclix_var = gen383_cyclix_var;
				if (gen384_cyclix_var) {
					gen385_cyclix_var = (genpstage_MEM_TRX_BUF[0].genmcopipe_handle_coproc_M_if.tid == genmcopipe_coproc_custom0_if_rd_ptr);
					gen386_cyclix_var = gen385_cyclix_var;
					if (gen386_cyclix_var) {
						gen387_cyclix_var = genmcopipe_coproc_custom0_if_resp.read_nb(gen441_pipex_mcopipe_rdata);
			...
			// Pipeline flush processing
			gen389_cyclix_var = genpstage_MEM_genpctrl_flushreq;
		...
		gen390_cyclix_var = gen399_pipex_var;
		if (gen390_cyclix_var) {
			...
			gen393_cyclix_var = genpstage_MEM_genctrl_active;
		...
		if (gen394_cyclix_var) {
			...
			gen395_cyclix_var = gen402_pipex_var;
			if (gen395_cyclix_var) {
				...
				gen396_cyclix_var = genpstage_MEM_genctrl_active;
				if (gen396_cyclix_var) {
					gen397_cyclix_var = ~genmcopipe_data_mem_full_flag;
					...
					if (gen398_cyclix_var) {
						...
						gen399_cyclix_var = genmcopipe_data_mem_req.write_nb(gen442_pipex_req_struct);
						gen400_cyclix_var = gen399_cyclix_var;
						if (gen400_cyclix_var) {
							gen403_pipex_var = ap_uint<32>(1);
							gen401_cyclix_var = !genpstage_MEM_TRX_LOCAL.mem_cmd;
							genpstage_MEM_TRX_BUF = gen401_cyclix_var;
							genpstage_MEM_TRX_BUF = genmcopipe_data_mem_wr_ptr;
							genpstage_MEM_TRX_BUF = ap_uint<1>(0);
							gen402_cyclix_var = genpstage_MEM_TRX_BUF[0].genmcopipe_handle_data_mem.rdreq_pending;
				...
				gen403_cyclix_var = genpstage_MEM_genctrl_active;
			...
			gen404_cyclix_var = gen405_pipex_var;
			if (gen404_cyclix_var) {
				gen405_cyclix_var = genpstage_MEM_genctrl_active;
		...
		// Processing of next pstage busyness
		gen406_cyclix_var = ~genpstage_WB_genctrl_rdy;
		gen407_cyclix_var = gen406_cyclix_var;
		if (gen407_cyclix_var) {
			gen408_cyclix_var = genpstage_MEM_genctrl_active;
		...
		// pctrl_finish and pctrl_succ formation
		gen409_cyclix_var = genpstage_MEM_genctrl_stalled_glbl;
		...
		// asserting succ signals
		// processing context in case transaction is ready to propagate
		gen411_cyclix_var = genpstage_MEM_genctrl_finish;
		if (gen411_cyclix_var) {
			// programming next stage in case transaction is able to propagate
			gen412_cyclix_var = genpstage_MEM_genctrl_succ;
			if (gen412_cyclix_var) {
				gen413_cyclix_var = genpstage_WB_genctrl_rdy;
		...
		gen414_cyclix_var = ~genpstage_MEM_TRX_BUF_COUNTER_FULL;
		genpstage_MEM_genctrl_rdy = gen414_cyclix_var;
		...
		gen415_cyclix_var = genpstage_EXEC_genctrl_stalled_glbl;
		if (gen415_cyclix_var) {
			genpstage_EXEC_genctrl_new = ap_uint<32>(0);
			genpstage_EXEC_genctrl_stalled_glbl = ap_uint<32>(0);
			genpstage_EXEC_genctrl_active = ap_uint<32>(1);
		}
		gen416_cyclix_var = ap_uint<1>(0);
		gen416_cyclix_var = (gen416_cyclix_var || gen415_cyclix_var);
		gen416_cyclix_var = !gen416_cyclix_var;
		...
		gen417_cyclix_var = genpstage_EXEC_genctrl_occupied;
		if (gen417_cyclix_var) {
			// Initializing new newaccums descriptors ####
			gen418_cyclix_var = genpstage_EXEC_genctrl_new;
			...
			// Acquiring mcopipe rdata
			gen419_cyclix_var = genpstage_EXEC_TRX_BUF[0].genmcopipe_handle_coproc_M_if.rdreq_pending;
			if (gen419_cyclix_var) {
				gen420_cyclix_var = (genpstage_EXEC_TRX_BUF[0].genmcopipe_handle_coproc_M_if.if_id == ap_uint<1>(0));
				gen421_cyclix_var = gen420_cyclix_var;
				if (gen421_cyclix_var) {
					gen422_cyclix_var = (genpstage_EXEC_TRX_BUF[0].genmcopipe_handle_coproc_M_if.tid == genmcopipe_coproc_M_if_rd_ptr);
					gen423_cyclix_var = gen422_cyclix_var;
					if (gen423_cyclix_var) {
						gen424_cyclix_var = genmcopipe_coproc_M_if_resp.read_nb(gen443_pipex_mcopipe_rdata);
						gen425_cyclix_var = gen424_cyclix_var;
				...
				gen426_cyclix_var = (genpstage_EXEC_TRX_BUF[0].genmcopipe_handle_coproc_M_if.if_id == ap_uint<1>(1));
				gen427_cyclix_var = gen426_cyclix_var;
				if (gen427_cyclix_var) {
					gen428_cyclix_var = (genpstage_EXEC_TRX_BUF[0].genmcopipe_handle_coproc_M_if.tid == genmcopipe_coproc_custom0_if_rd_ptr);
					gen429_cyclix_var = gen428_cyclix_var;
					if (gen429_cyclix_var) {
						gen430_cyclix_var = genmcopipe_coproc_custom0_if_resp.read_nb(gen444_pipex_mcopipe_rdata);
			...
			// Pipeline flush processing
			gen432_cyclix_var = genpstage_EXEC_genpctrl_flushreq;
		...
		gen433_cyclix_var = gen343_pipex_var;
		...
		if (gen434_cyclix_var) {
			...
			gen435_cyclix_var = gen346_pipex_var;
			if (gen435_cyclix_var) {
				gen436_cyclix_var = genpstage_EXEC_genctrl_active;
				if (gen436_cyclix_var) {
					gen437_cyclix_var = irq_fifo.read_nb(genpstage_EXEC_TRX_LOCAL);
					gen347_pipex_var = gen437_cyclix_var;
				}
				...
				gen439_cyclix_var = genpstage_EXEC_genctrl_active;
			...
			gen440_cyclix_var = gen348_pipex_var;
			if (gen440_cyclix_var) {
				...
				gen443_cyclix_var = genpstage_EXEC_genctrl_active;
		...
		gen444_cyclix_var = gen349_pipex_var;
		if (gen444_cyclix_var) {
			gen445_cyclix_var = genpstage_EXEC_genctrl_active;
		...
		gen446_cyclix_var = gen351_pipex_var;
		if (gen446_cyclix_var) {
			gen352_pipex_var = genpstage_EXEC_TRX_LOCAL.m_ext_req;
			gen447_cyclix_var = gen352_pipex_var;
			if (gen447_cyclix_var) {
				gen448_cyclix_var = genpstage_EXEC_genctrl_active;
				if (gen448_cyclix_var) {
					gen449_cyclix_var = ~genmcopipe_coproc_M_if_full_flag;
					...
					if (gen450_cyclix_var) {
						...
						gen451_cyclix_var = genmcopipe_coproc_M_if_req.write_nb(gen445_pipex_req_struct);
						gen452_cyclix_var = gen451_cyclix_var;
						if (gen452_cyclix_var) {
							gen353_pipex_var = ap_uint<32>(1);
							gen453_cyclix_var = !ap_uint<32>(0);
							genpstage_EXEC_TRX_BUF = gen453_cyclix_var;
							genpstage_EXEC_TRX_BUF = genmcopipe_coproc_M_if_wr_ptr;
							genpstage_EXEC_TRX_BUF = ap_uint<1>(0);
							gen454_cyclix_var = genpstage_EXEC_TRX_BUF[0].genmcopipe_handle_coproc_M_if.rdreq_pending;
				...
				gen455_cyclix_var = genpstage_EXEC_genctrl_active;
				...
				gen456_cyclix_var = gen355_pipex_var;
			...
			gen458_cyclix_var = gen356_pipex_var;
			if (gen458_cyclix_var) {
				gen459_cyclix_var = genpstage_EXEC_genctrl_active;
				if (gen459_cyclix_var) {
					gen460_cyclix_var = ~genmcopipe_coproc_custom0_if_full_flag;
					...
					if (gen461_cyclix_var) {
						...
						gen462_cyclix_var = genmcopipe_coproc_custom0_if_req.write_nb(gen446_pipex_req_struct);
						gen463_cyclix_var = gen462_cyclix_var;
						if (gen463_cyclix_var) {
							gen357_pipex_var = ap_uint<32>(1);
							gen464_cyclix_var = !ap_uint<32>(0);
							genpstage_EXEC_TRX_BUF = gen464_cyclix_var;
							genpstage_EXEC_TRX_BUF = genmcopipe_coproc_custom0_if_wr_ptr;
							genpstage_EXEC_TRX_BUF = ap_uint<1>(1);
							gen465_cyclix_var = genpstage_EXEC_TRX_BUF[0].genmcopipe_handle_coproc_M_if.rdreq_pending;
				...
				gen467_cyclix_var = gen359_pipex_var;
		...
		gen469_cyclix_var = gen360_pipex_var;
		if (gen469_cyclix_var) {
			...
			gen470_cyclix_var = gen385_pipex_var;
		...
		genpstage_EXEC_TRX_LOCAL = gen387_pipex_var;
		switch (genpstage_EXEC_TRX_LOCAL) {
			case 0:
				genpstage_EXEC_TRX_LOCAL = genpstage_EXEC_TRX_LOCAL.immediate;
				break;
		...
		gen472_cyclix_var = gen388_pipex_var;
		if (gen472_cyclix_var) {
			switch (genpstage_EXEC_TRX_LOCAL) {
				...
				case 1:
					...
					gen474_cyclix_var = gen391_pipex_var;
				...
				case 5:
					...
					gen476_cyclix_var = gen394_pipex_var;
				...
				case 7:
					...
					gen478_cyclix_var = gen397_pipex_var;
		...
		// Processing of next pstage busyness
		gen479_cyclix_var = ~genpstage_MEM_genctrl_rdy;
		gen480_cyclix_var = gen479_cyclix_var;
		if (gen480_cyclix_var) {
			gen481_cyclix_var = genpstage_EXEC_genctrl_active;
		...
		// pctrl_finish and pctrl_succ formation
		gen482_cyclix_var = genpstage_EXEC_genctrl_stalled_glbl;
		...
		// asserting succ signals
		// processing context in case transaction is ready to propagate
		gen484_cyclix_var = genpstage_EXEC_genctrl_finish;
		if (gen484_cyclix_var) {
			// programming next stage in case transaction is able to propagate
			gen485_cyclix_var = genpstage_EXEC_genctrl_succ;
			if (gen485_cyclix_var) {
				gen486_cyclix_var = genpstage_MEM_genctrl_rdy;
		...
		gen487_cyclix_var = ~genpstage_EXEC_TRX_BUF_COUNTER_FULL;
		genpstage_EXEC_genctrl_rdy = gen487_cyclix_var;
		...
		gen488_cyclix_var = genpstage_IDECODE_genctrl_stalled_glbl;
		if (gen488_cyclix_var) {
			genpstage_IDECODE_genctrl_new = ap_uint<32>(0);
			genpstage_IDECODE_genctrl_stalled_glbl = ap_uint<32>(0);
			genpstage_IDECODE_genctrl_active = ap_uint<32>(1);
		}
		gen489_cyclix_var = ap_uint<1>(0);
		gen489_cyclix_var = (gen489_cyclix_var || gen488_cyclix_var);
		gen489_cyclix_var = !gen489_cyclix_var;
		...
		gen490_cyclix_var = genpstage_IDECODE_genctrl_occupied;
		if (gen490_cyclix_var) {
			// Initializing new newaccums descriptors ####
			gen491_cyclix_var = genpstage_IDECODE_genctrl_new;
			...
			// Acquiring mcopipe rdata
			gen492_cyclix_var = genpstage_IDECODE_TRX_BUF[0].genmcopipe_handle_instr_mem.rdreq_pending;
			if (gen492_cyclix_var) {
				gen493_cyclix_var = (genpstage_IDECODE_TRX_BUF[0].genmcopipe_handle_instr_mem.if_id == ap_uint<1>(0));
				gen494_cyclix_var = gen493_cyclix_var;
				if (gen494_cyclix_var) {
					gen495_cyclix_var = (genpstage_IDECODE_TRX_BUF[0].genmcopipe_handle_instr_mem.tid == genmcopipe_instr_mem_rd_ptr);
					gen496_cyclix_var = gen495_cyclix_var;
					if (gen496_cyclix_var) {
						gen497_cyclix_var = genmcopipe_instr_mem_resp.read_nb(gen447_pipex_mcopipe_rdata);
			...
			// Pipeline flush processing
			gen499_cyclix_var = genpstage_IDECODE_genpctrl_flushreq;
		...
		gen500_cyclix_var = gen227_pipex_var;
		if (gen500_cyclix_var) {
			genpstage_IDECODE_genctrl_active = ap_uint<32>(0);
		}
		gen501_cyclix_var = genpstage_IDECODE_TRX_BUF[0].genmcopipe_handle_instr_mem.resp_done;
		...
		gen502_cyclix_var = gen230_pipex_var;
		if (gen502_cyclix_var) {
			gen503_cyclix_var = genpstage_IDECODE_genctrl_active;
			...
			case 19:
				...
				switch (genpstage_IDECODE_TRX_LOCAL) {
					...
					case 5:
						...
						gen505_cyclix_var = gen249_pipex_var;
			...
			case 51:
				...
				switch (genpstage_IDECODE_TRX_LOCAL) {
					case 0:
						...
						gen507_cyclix_var = gen252_pipex_var;
						...
						gen508_cyclix_var = gen253_pipex_var;
					...
					case 5:
						...
						gen509_cyclix_var = gen254_pipex_var;
				...
				gen511_cyclix_var = gen257_pipex_var;
			...
			case 115:
				switch (genpstage_IDECODE_TRX_LOCAL) {
					case 0:
						...
						gen512_cyclix_var = gen258_pipex_var;
						...
						gen513_cyclix_var = gen259_pipex_var;
		...
		gen516_cyclix_var = gen267_pipex_var;
		...
		if (gen521_cyclix_var) {
			...
			if (gen522_cyclix_var) {
				...
				if (gen523_cyclix_var) {
					...
					gen526_cyclix_var = gen286_pipex_var;
					if (gen526_cyclix_var) {
						gen527_cyclix_var = genpstage_IDECODE_genctrl_active;
			...
			gen528_cyclix_var = gen287_pipex_var;
			if (gen528_cyclix_var) {
				...
				if (gen529_cyclix_var) {
					...
					gen532_cyclix_var = gen294_pipex_var;
					if (gen532_cyclix_var) {
						gen533_cyclix_var = genpstage_IDECODE_genctrl_active;
		...
		if (gen534_cyclix_var) {
			...
			if (gen535_cyclix_var) {
				...
				if (gen536_cyclix_var) {
					...
					gen537_cyclix_var = gen304_pipex_var;
					...
					gen539_cyclix_var = gen306_pipex_var;
			...
			gen541_cyclix_var = gen307_pipex_var;
			if (gen541_cyclix_var) {
				...
				if (gen542_cyclix_var) {
					...
					gen543_cyclix_var = gen312_pipex_var;
					...
					gen545_cyclix_var = gen314_pipex_var;
		...
		if (gen547_cyclix_var) {
			...
			if (gen548_cyclix_var) {
				...
				if (gen549_cyclix_var) {
					...
					gen550_cyclix_var = gen324_pipex_var;
					...
					gen552_cyclix_var = gen326_pipex_var;
			...
			gen554_cyclix_var = gen327_pipex_var;
			if (gen554_cyclix_var) {
				...
				if (gen555_cyclix_var) {
					...
					gen556_cyclix_var = gen332_pipex_var;
					...
					gen558_cyclix_var = gen334_pipex_var;
		...
		gen560_cyclix_var = gen335_pipex_var;
		...
		gen561_cyclix_var = gen338_pipex_var;
		...
		// Processing of next pstage busyness
		gen562_cyclix_var = ~genpstage_EXEC_genctrl_rdy;
		gen563_cyclix_var = gen562_cyclix_var;
		...
		// pctrl_finish and pctrl_succ formation
		gen565_cyclix_var = genpstage_IDECODE_genctrl_stalled_glbl;
		if (gen565_cyclix_var) {
			genpstage_IDECODE_genctrl_finish = ap_uint<32>(0);
			genpstage_IDECODE_genctrl_succ = ap_uint<32>(0);
		}
		gen566_cyclix_var = ap_uint<1>(0);
		gen566_cyclix_var = (gen566_cyclix_var || gen565_cyclix_var);
		gen566_cyclix_var = !gen566_cyclix_var;
		...
		// asserting succ signals
		// processing context in case transaction is ready to propagate
		gen567_cyclix_var = genpstage_IDECODE_genctrl_finish;
		if (gen567_cyclix_var) {
			// programming next stage in case transaction is able to propagate
			gen568_cyclix_var = genpstage_IDECODE_genctrl_succ;
			if (gen568_cyclix_var) {
				gen569_cyclix_var = genpstage_EXEC_genctrl_rdy;
		...
		gen570_cyclix_var = ~genpstage_IDECODE_TRX_BUF_COUNTER_FULL;
		genpstage_IDECODE_genctrl_rdy = gen570_cyclix_var;
		...
		gen571_cyclix_var = genpstage_IFETCH_genctrl_stalled_glbl;
		if (gen571_cyclix_var) {
			genpstage_IFETCH_genctrl_new = ap_uint<32>(0);
			genpstage_IFETCH_genctrl_stalled_glbl = ap_uint<32>(0);
			genpstage_IFETCH_genctrl_active = ap_uint<32>(1);
		}
		gen572_cyclix_var = ap_uint<1>(0);
		gen572_cyclix_var = (gen572_cyclix_var || gen571_cyclix_var);
		gen572_cyclix_var = !gen572_cyclix_var;
		...
		gen573_cyclix_var = genpstage_IFETCH_genctrl_occupied;
		if (gen573_cyclix_var) {
			// Initializing new newaccums descriptors ####
			gen574_cyclix_var = genpstage_IFETCH_genctrl_new;
			...
			// Acquiring mcopipe rdata
			gen575_cyclix_var = genpstage_IFETCH_TRX_BUF[0].genmcopipe_handle_instr_mem.rdreq_pending;
			if (gen575_cyclix_var) {
				gen576_cyclix_var = (genpstage_IFETCH_TRX_BUF[0].genmcopipe_handle_instr_mem.if_id == ap_uint<1>(0));
				gen577_cyclix_var = gen576_cyclix_var;
				if (gen577_cyclix_var) {
					gen578_cyclix_var = (genpstage_IFETCH_TRX_BUF[0].genmcopipe_handle_instr_mem.tid == genmcopipe_instr_mem_rd_ptr);
					gen579_cyclix_var = gen578_cyclix_var;
					if (gen579_cyclix_var) {
						gen580_cyclix_var = genmcopipe_instr_mem_resp.read_nb(gen448_pipex_mcopipe_rdata);
			...
			// Pipeline flush processing
			gen582_cyclix_var = genpstage_IFETCH_genpctrl_flushreq;
		...
		gen583_cyclix_var = gen219_pipex_var;
		...
		gen220_pipex_var = (genpstage_IFETCH_TRX_LOCAL.curinstr_addr + ap_uint<32>(4));
		genpstage_IFETCH_TRX_LOCAL = gen220_pipex_var;
		...
		gen588_cyclix_var = gen223_pipex_var;
		if (gen588_cyclix_var) {
			gen589_cyclix_var = genpstage_IFETCH_genctrl_active;
			if (gen589_cyclix_var) {
				gen590_cyclix_var = ~genmcopipe_instr_mem_full_flag;
				...
				if (gen591_cyclix_var) {
					...
					gen592_cyclix_var = genmcopipe_instr_mem_req.write_nb(gen449_pipex_req_struct);
					gen593_cyclix_var = gen592_cyclix_var;
					if (gen593_cyclix_var) {
						gen224_pipex_var = ap_uint<32>(1);
						gen594_cyclix_var = !ap_uint<1>(0);
						genpstage_IFETCH_TRX_BUF = gen594_cyclix_var;
						genpstage_IFETCH_TRX_BUF = genmcopipe_instr_mem_wr_ptr;
						genpstage_IFETCH_TRX_BUF = ap_uint<1>(0);
						gen595_cyclix_var = genpstage_IFETCH_TRX_BUF[0].genmcopipe_handle_instr_mem.rdreq_pending;
		...
		gen597_cyclix_var = gen226_pipex_var;
		if (gen597_cyclix_var) {
			gen598_cyclix_var = genpstage_IFETCH_genctrl_active;
		...
		// Processing of next pstage busyness
		gen599_cyclix_var = ~genpstage_IDECODE_genctrl_rdy;
		gen600_cyclix_var = gen599_cyclix_var;
		...
		// pctrl_finish and pctrl_succ formation
		gen602_cyclix_var = genpstage_IFETCH_genctrl_stalled_glbl;
		if (gen602_cyclix_var) {
			genpstage_IFETCH_genctrl_finish = ap_uint<32>(0);
			genpstage_IFETCH_genctrl_succ = ap_uint<32>(0);
		}
		gen603_cyclix_var = ap_uint<1>(0);
		gen603_cyclix_var = (gen603_cyclix_var || gen602_cyclix_var);
		...
		// credit counter processing
		// asserting succ signals
		gen604_cyclix_var = genpstage_IFETCH_genctrl_succ;
		if (gen604_cyclix_var) {
			gen605_cyclix_var = gen217_pipex_succreq;
			if (gen605_cyclix_var) {
				genpsticky_glbl_pc = gen218_pipex_succbuf;
			}
		}
		// processing context in case transaction is ready to propagate
		gen606_cyclix_var = genpstage_IFETCH_genctrl_finish;
		if (gen606_cyclix_var) {
			// programming next stage in case transaction is able to propagate
			gen607_cyclix_var = genpstage_IFETCH_genctrl_succ;
			if (gen607_cyclix_var) {
				gen608_cyclix_var = genpstage_IDECODE_genctrl_rdy;
		...
		gen609_cyclix_var = ~genpstage_IFETCH_TRX_BUF_COUNTER_FULL;
		genpstage_IFETCH_genctrl_rdy = gen609_cyclix_var;
		genpstage_IFETCH_genctrl_working = (genpstage_IFETCH_genctrl_succ | genpstage_IFETCH_genctrl_stalled_glbl);
		gen610_cyclix_var = genmcopipe_instr_mem_rd_done;
		if (gen610_cyclix_var) {
			genmcopipe_instr_mem_rd_ptr = genmcopipe_instr_mem_rd_ptr_next;
			genmcopipe_instr_mem_full_flag = ap_uint<32>(0);
			gen611_cyclix_var = (genmcopipe_instr_mem_rd_ptr == genmcopipe_instr_mem_wr_ptr);
			gen612_cyclix_var = gen611_cyclix_var;
			if (gen612_cyclix_var) {
				genmcopipe_instr_mem_empty_flag = ap_uint<32>(1);
			}
		}
		gen613_cyclix_var = genmcopipe_instr_mem_wr_done;
		if (gen613_cyclix_var) {
			...
			gen614_cyclix_var = (genmcopipe_instr_mem_rd_ptr == genmcopipe_instr_mem_wr_ptr);
			gen615_cyclix_var = gen614_cyclix_var;
			if (gen615_cyclix_var) {
				genmcopipe_instr_mem_full_flag = ap_uint<32>(1);
			}
		}
		gen616_cyclix_var = genmcopipe_data_mem_rd_done;
		if (gen616_cyclix_var) {
			genmcopipe_data_mem_rd_ptr = genmcopipe_data_mem_rd_ptr_next;
			genmcopipe_data_mem_full_flag = ap_uint<32>(0);
			gen617_cyclix_var = (genmcopipe_data_mem_rd_ptr == genmcopipe_data_mem_wr_ptr);
			gen618_cyclix_var = gen617_cyclix_var;
			if (gen618_cyclix_var) {
				genmcopipe_data_mem_empty_flag = ap_uint<32>(1);
			}
		}
		gen619_cyclix_var = genmcopipe_data_mem_wr_done;
		if (gen619_cyclix_var) {
			...
			gen620_cyclix_var = (genmcopipe_data_mem_rd_ptr == genmcopipe_data_mem_wr_ptr);
			gen621_cyclix_var = gen620_cyclix_var;
			if (gen621_cyclix_var) {
				genmcopipe_data_mem_full_flag = ap_uint<32>(1);
			}
		}
		gen622_cyclix_var = genmcopipe_coproc_M_if_rd_done;
		if (gen622_cyclix_var) {
			genmcopipe_coproc_M_if_rd_ptr = genmcopipe_coproc_M_if_rd_ptr_next;
			genmcopipe_coproc_M_if_full_flag = ap_uint<32>(0);
			gen623_cyclix_var = (genmcopipe_coproc_M_if_rd_ptr == genmcopipe_coproc_M_if_wr_ptr);
			gen624_cyclix_var = gen623_cyclix_var;
			if (gen624_cyclix_var) {
				genmcopipe_coproc_M_if_empty_flag = ap_uint<32>(1);
			}
		}
		gen625_cyclix_var = genmcopipe_coproc_M_if_wr_done;
		if (gen625_cyclix_var) {
			...
			gen626_cyclix_var = (genmcopipe_coproc_M_if_rd_ptr == genmcopipe_coproc_M_if_wr_ptr);
			gen627_cyclix_var = gen626_cyclix_var;
			if (gen627_cyclix_var) {
				genmcopipe_coproc_M_if_full_flag = ap_uint<32>(1);
			}
		}
		gen628_cyclix_var = genmcopipe_coproc_custom0_if_rd_done;
		if (gen628_cyclix_var) {
			genmcopipe_coproc_custom0_if_rd_ptr = genmcopipe_coproc_custom0_if_rd_ptr_next;
			genmcopipe_coproc_custom0_if_full_flag = ap_uint<32>(0);
			gen629_cyclix_var = (genmcopipe_coproc_custom0_if_rd_ptr == genmcopipe_coproc_custom0_if_wr_ptr);
			gen630_cyclix_var = gen629_cyclix_var;
			if (gen630_cyclix_var) {
				genmcopipe_coproc_custom0_if_empty_flag = ap_uint<32>(1);
			}
		}
		gen631_cyclix_var = genmcopipe_coproc_custom0_if_wr_done;
		if (gen631_cyclix_var) {
			...
			gen632_cyclix_var = (genmcopipe_coproc_custom0_if_rd_ptr == genmcopipe_coproc_custom0_if_wr_ptr);
			gen633_cyclix_var = gen632_cyclix_var;
