...
genpmodule_riscv_5stage_genmcopipe_data_mem_genstruct_fifo_wdata gen442_pipex_req_struct;
...
genpmodule_riscv_5stage_genmcopipe_coproc_M_if_genstruct_fifo_wdata gen445_pipex_req_struct;
genpmodule_riscv_5stage_genmcopipe_coproc_custom0_if_genstruct_fifo_wdata gen446_pipex_req_struct;
...
genpmodule_riscv_5stage_genmcopipe_instr_mem_genstruct_fifo_wdata gen449_pipex_req_struct;
...
logic unsigned [31:0] gen517_cyclix_var [31:1];
...
logic unsigned [31:0] gen834_cyclix_genvar [31:1];
...
always @*
	...
	// Buffering globals
	gen834_cyclix_genvar[1] = genpsticky_glbl_regfile[1];
	gen834_cyclix_genvar[2] = genpsticky_glbl_regfile[2];
	gen834_cyclix_genvar[3] = genpsticky_glbl_regfile[3];
	gen834_cyclix_genvar[4] = genpsticky_glbl_regfile[4];
	gen834_cyclix_genvar[5] = genpsticky_glbl_regfile[5];
	gen834_cyclix_genvar[6] = genpsticky_glbl_regfile[6];
	gen834_cyclix_genvar[7] = genpsticky_glbl_regfile[7];
	gen834_cyclix_genvar[8] = genpsticky_glbl_regfile[8];
	gen834_cyclix_genvar[9] = genpsticky_glbl_regfile[9];
	gen834_cyclix_genvar[10] = genpsticky_glbl_regfile[10];
	gen834_cyclix_genvar[11] = genpsticky_glbl_regfile[11];
	gen834_cyclix_genvar[12] = genpsticky_glbl_regfile[12];
	gen834_cyclix_genvar[13] = genpsticky_glbl_regfile[13];
	gen834_cyclix_genvar[14] = genpsticky_glbl_regfile[14];
	gen834_cyclix_genvar[15] = genpsticky_glbl_regfile[15];
	gen834_cyclix_genvar[16] = genpsticky_glbl_regfile[16];
	gen834_cyclix_genvar[17] = genpsticky_glbl_regfile[17];
	gen834_cyclix_genvar[18] = genpsticky_glbl_regfile[18];
	gen834_cyclix_genvar[19] = genpsticky_glbl_regfile[19];
	gen834_cyclix_genvar[20] = genpsticky_glbl_regfile[20];
	gen834_cyclix_genvar[21] = genpsticky_glbl_regfile[21];
	gen834_cyclix_genvar[22] = genpsticky_glbl_regfile[22];
	gen834_cyclix_genvar[23] = genpsticky_glbl_regfile[23];
	gen834_cyclix_genvar[24] = genpsticky_glbl_regfile[24];
	gen834_cyclix_genvar[25] = genpsticky_glbl_regfile[25];
	gen834_cyclix_genvar[26] = genpsticky_glbl_regfile[26];
	gen834_cyclix_genvar[27] = genpsticky_glbl_regfile[27];
	gen834_cyclix_genvar[28] = genpsticky_glbl_regfile[28];
	gen834_cyclix_genvar[29] = genpsticky_glbl_regfile[29];
	gen834_cyclix_genvar[30] = genpsticky_glbl_regfile[30];
	gen834_cyclix_genvar[31] = genpsticky_glbl_regfile[31];
	// fifo_in buffering
	...
	gen634_cyclix_genvar = genpstage_WB_genctrl_stalled_glbl;
	gen0_rtl_var = gen634_cyclix_genvar;
	if (gen0_rtl_var)
		begin
		genpstage_WB_genctrl_new = 32'd0;
		genpstage_WB_genctrl_stalled_glbl = 32'd0;
	...
	gen635_cyclix_genvar = 1'd0;
	gen635_cyclix_genvar = (gen635_cyclix_genvar || gen634_cyclix_genvar);
	gen635_cyclix_genvar = !gen635_cyclix_genvar;
	gen1_rtl_var = gen635_cyclix_genvar;
	if (gen1_rtl_var)
		begin
	...
	gen636_cyclix_genvar = genpstage_WB_genctrl_occupied;
	gen2_rtl_var = gen636_cyclix_genvar;
	if (gen2_rtl_var)
		begin
		...
		gen637_cyclix_genvar = genpstage_WB_TRX_BUF[0].genmcopipe_handle_data_mem.rdreq_pending;
		gen3_rtl_var = gen637_cyclix_genvar;
		if (gen3_rtl_var)
			begin
			gen638_cyclix_genvar = (genpstage_WB_TRX_BUF[0].genmcopipe_handle_data_mem.if_id == 1'd0);
			gen639_cyclix_genvar = gen638_cyclix_genvar;
			gen4_rtl_var = gen639_cyclix_genvar;
			if (gen4_rtl_var)
				begin
				gen640_cyclix_genvar = (genpstage_WB_TRX_BUF[0].genmcopipe_handle_data_mem.tid == genmcopipe_data_mem_rd_ptr);
				gen641_cyclix_genvar = gen640_cyclix_genvar;
				gen5_rtl_var = gen641_cyclix_genvar;
				if (gen5_rtl_var)
					begin
					gen6_rtl_var = !rst_i;
		...
		gen644_cyclix_genvar = genpstage_WB_TRX_BUF[0].genmcopipe_handle_coproc_M_if.rdreq_pending;
		gen10_rtl_var = gen644_cyclix_genvar;
		if (gen10_rtl_var)
			begin
			gen645_cyclix_genvar = (genpstage_WB_TRX_BUF[0].genmcopipe_handle_coproc_M_if.if_id == 1'd0);
			gen646_cyclix_genvar = gen645_cyclix_genvar;
			gen11_rtl_var = gen646_cyclix_genvar;
			if (gen11_rtl_var)
				begin
				gen647_cyclix_genvar = (genpstage_WB_TRX_BUF[0].genmcopipe_handle_coproc_M_if.tid == genmcopipe_coproc_M_if_rd_ptr);
				gen648_cyclix_genvar = gen647_cyclix_genvar;
				gen12_rtl_var = gen648_cyclix_genvar;
				if (gen12_rtl_var)
					begin
					gen13_rtl_var = !rst_i;
					...
					gen16_rtl_var = gen650_cyclix_genvar;
					if (gen16_rtl_var)
						begin
			...
			gen651_cyclix_genvar = (genpstage_WB_TRX_BUF[0].genmcopipe_handle_coproc_M_if.if_id == 1'd1);
			gen652_cyclix_genvar = gen651_cyclix_genvar;
			gen17_rtl_var = gen652_cyclix_genvar;
			if (gen17_rtl_var)
				begin
				gen653_cyclix_genvar = (genpstage_WB_TRX_BUF[0].genmcopipe_handle_coproc_M_if.tid == genmcopipe_coproc_custom0_if_rd_ptr);
				gen654_cyclix_genvar = gen653_cyclix_genvar;
				gen18_rtl_var = gen654_cyclix_genvar;
				if (gen18_rtl_var)
					begin
					gen19_rtl_var = !rst_i;
					...
					gen22_rtl_var = gen656_cyclix_genvar;
					if (gen22_rtl_var)
						begin
						genpstage_WB_TRX_BUF[0].genmcopipe_handle_coproc_M_if.rdreq_pending = 32'd0;
						genpstage_WB_TRX_BUF[0].genmcopipe_handle_coproc_M_if.resp_done = 32'd1;
		...
		gen657_cyclix_genvar = genpstage_WB_genpctrl_flushreq;
		gen23_rtl_var = gen657_cyclix_genvar;
		if (gen23_rtl_var)
			begin
			genpstage_WB_genctrl_active = 32'd0;
			end
	...
	gen658_cyclix_genvar = gen406_pipex_var;
	gen24_rtl_var = gen658_cyclix_genvar;
	if (gen24_rtl_var)
		begin
		gen407_pipex_var = ~genpstage_WB_TRX_LOCAL.mem_cmd;
		gen408_pipex_var = gen407_pipex_var;
		gen659_cyclix_genvar = gen408_pipex_var;
		gen25_rtl_var = gen659_cyclix_genvar;
		if (gen25_rtl_var)
			begin
			gen660_cyclix_genvar = genpstage_WB_TRX_BUF[0].genmcopipe_handle_data_mem.resp_done;
			gen26_rtl_var = gen660_cyclix_genvar;
			if (gen26_rtl_var)
				begin
			...
			gen661_cyclix_genvar = gen410_pipex_var;
			gen27_rtl_var = gen661_cyclix_genvar;
			if (gen27_rtl_var)
				begin
			...
			gen28_rtl_var = gen662_cyclix_genvar;
			if (gen28_rtl_var)
				begin
				gen663_cyclix_genvar = genpstage_WB_genctrl_active;
				gen29_rtl_var = gen663_cyclix_genvar;
				if (gen29_rtl_var)
					begin
	...
	gen664_cyclix_genvar = gen413_pipex_var;
	gen30_rtl_var = gen664_cyclix_genvar;
	if (gen30_rtl_var)
		begin
		gen414_pipex_var = genpstage_WB_TRX_LOCAL.load_signext;
		gen665_cyclix_genvar = gen414_pipex_var;
		gen31_rtl_var = gen665_cyclix_genvar;
		if (gen31_rtl_var)
			begin
		...
		gen666_cyclix_genvar = gen418_pipex_var;
		gen32_rtl_var = gen666_cyclix_genvar;
		if (gen32_rtl_var)
			begin
	...
	gen667_cyclix_genvar = gen421_pipex_var;
	gen33_rtl_var = gen667_cyclix_genvar;
	if (gen33_rtl_var)
		begin
		gen422_pipex_var = genpstage_WB_TRX_LOCAL.load_signext;
		gen668_cyclix_genvar = gen422_pipex_var;
		gen34_rtl_var = gen668_cyclix_genvar;
		if (gen34_rtl_var)
			begin
		...
		gen669_cyclix_genvar = gen426_pipex_var;
		gen35_rtl_var = gen669_cyclix_genvar;
		if (gen35_rtl_var)
			begin
	...
	gen670_cyclix_genvar = gen429_pipex_var;
	gen36_rtl_var = gen670_cyclix_genvar;
	if (gen36_rtl_var)
		begin
	...
	gen37_rtl_var = gen671_cyclix_genvar;
	if (gen37_rtl_var)
		begin
		gen672_cyclix_genvar = genpstage_WB_TRX_BUF[0].genmcopipe_handle_coproc_M_if.resp_done;
		gen38_rtl_var = gen672_cyclix_genvar;
		if (gen38_rtl_var)
			begin
		...
		gen673_cyclix_genvar = gen432_pipex_var;
		gen39_rtl_var = gen673_cyclix_genvar;
		if (gen39_rtl_var)
			begin
			genpstage_WB_TRX_LOCAL.rd_rdy = 32'd1;
			end
		...
		gen40_rtl_var = gen674_cyclix_genvar;
		if (gen40_rtl_var)
			begin
			gen675_cyclix_genvar = genpstage_WB_genctrl_active;
			gen41_rtl_var = gen675_cyclix_genvar;
			if (gen41_rtl_var)
				begin
				genpstage_WB_genctrl_stalled_glbl = 32'd1;
				end
	...
	gen676_cyclix_genvar = gen435_pipex_var;
	gen42_rtl_var = gen676_cyclix_genvar;
	if (gen42_rtl_var)
		begin
	...
	gen677_cyclix_genvar = genpstage_WB_genctrl_stalled_glbl;
	gen43_rtl_var = gen677_cyclix_genvar;
	if (gen43_rtl_var)
		begin
		genpstage_WB_genctrl_finish = 32'd0;
		genpstage_WB_genctrl_succ = 32'd0;
		end
	gen678_cyclix_genvar = 1'd0;
	gen678_cyclix_genvar = (gen678_cyclix_genvar || gen677_cyclix_genvar);
	gen678_cyclix_genvar = !gen678_cyclix_genvar;
	gen44_rtl_var = gen678_cyclix_genvar;
	if (gen44_rtl_var)
		begin
	...
	gen679_cyclix_genvar = genpstage_WB_genctrl_finish;
	gen45_rtl_var = gen679_cyclix_genvar;
	if (gen45_rtl_var)
		begin
		// programming next stage in case transaction is able to propagate
		gen680_cyclix_genvar = genpstage_WB_genctrl_succ;
		gen46_rtl_var = gen680_cyclix_genvar;
		if (gen46_rtl_var)
			begin
			end
		genpstage_WB_genctrl_stalled_glbl = 32'd0;
	...
	gen681_cyclix_genvar = ~genpstage_WB_TRX_BUF_COUNTER_FULL;
	genpstage_WB_genctrl_rdy = gen681_cyclix_genvar;
	...
	gen682_cyclix_genvar = genpstage_MEM_genctrl_stalled_glbl;
	gen47_rtl_var = gen682_cyclix_genvar;
	if (gen47_rtl_var)
		begin
		genpstage_MEM_genctrl_new = 32'd0;
		genpstage_MEM_genctrl_stalled_glbl = 32'd0;
	...
	gen683_cyclix_genvar = 1'd0;
	gen683_cyclix_genvar = (gen683_cyclix_genvar || gen682_cyclix_genvar);
	gen683_cyclix_genvar = !gen683_cyclix_genvar;
	gen48_rtl_var = gen683_cyclix_genvar;
	if (gen48_rtl_var)
		begin
	...
	gen684_cyclix_genvar = genpstage_MEM_genctrl_occupied;
	gen49_rtl_var = gen684_cyclix_genvar;
	if (gen49_rtl_var)
		begin
		// Initializing new newaccums descriptors ####
		gen685_cyclix_genvar = genpstage_MEM_genctrl_new;
		gen50_rtl_var = gen685_cyclix_genvar;
		if (gen50_rtl_var)
			begin
		...
		// Acquiring mcopipe rdata
		gen686_cyclix_genvar = genpstage_MEM_TRX_BUF[0].genmcopipe_handle_data_mem.rdreq_pending;
		gen51_rtl_var = gen686_cyclix_genvar;
		if (gen51_rtl_var)
			begin
			gen687_cyclix_genvar = (genpstage_MEM_TRX_BUF[0].genmcopipe_handle_data_mem.if_id == 1'd0);
			gen688_cyclix_genvar = gen687_cyclix_genvar;
			gen52_rtl_var = gen688_cyclix_genvar;
			if (gen52_rtl_var)
				begin
				gen689_cyclix_genvar = (genpstage_MEM_TRX_BUF[0].genmcopipe_handle_data_mem.tid == genmcopipe_data_mem_rd_ptr);
				gen690_cyclix_genvar = gen689_cyclix_genvar;
				gen53_rtl_var = gen690_cyclix_genvar;
				if (gen53_rtl_var)
					begin
					gen54_rtl_var = !rst_i;
					...
					gen57_rtl_var = gen692_cyclix_genvar;
					if (gen57_rtl_var)
						begin
		...
		gen693_cyclix_genvar = genpstage_MEM_TRX_BUF[0].genmcopipe_handle_coproc_M_if.rdreq_pending;
		gen58_rtl_var = gen693_cyclix_genvar;
		if (gen58_rtl_var)
			begin
			gen694_cyclix_genvar = (genpstage_MEM_TRX_BUF[0].genmcopipe_handle_coproc_M_if.if_id == 1'd0);
			gen695_cyclix_genvar = gen694_cyclix_genvar;
			gen59_rtl_var = gen695_cyclix_genvar;
			if (gen59_rtl_var)
				begin
				gen696_cyclix_genvar = (genpstage_MEM_TRX_BUF[0].genmcopipe_handle_coproc_M_if.tid == genmcopipe_coproc_M_if_rd_ptr);
				gen697_cyclix_genvar = gen696_cyclix_genvar;
				gen60_rtl_var = gen697_cyclix_genvar;
				if (gen60_rtl_var)
					begin
					gen61_rtl_var = !rst_i;
					...
					gen64_rtl_var = gen699_cyclix_genvar;
					if (gen64_rtl_var)
						begin
			...
			gen700_cyclix_genvar = (genpstage_MEM_TRX_BUF[0].genmcopipe_handle_coproc_M_if.if_id == 1'd1);
			gen701_cyclix_genvar = gen700_cyclix_genvar;
			gen65_rtl_var = gen701_cyclix_genvar;
			if (gen65_rtl_var)
				begin
				gen702_cyclix_genvar = (genpstage_MEM_TRX_BUF[0].genmcopipe_handle_coproc_M_if.tid == genmcopipe_coproc_custom0_if_rd_ptr);
				gen703_cyclix_genvar = gen702_cyclix_genvar;
				gen66_rtl_var = gen703_cyclix_genvar;
				if (gen66_rtl_var)
					begin
					gen67_rtl_var = !rst_i;
					...
					if (gen68_rtl_var)
						...
						if (gen69_rtl_var)
							begin
							gen704_cyclix_genvar = 32'd1;
							gen441_pipex_mcopipe_rdata = genmcopipe_coproc_custom0_if_resp_genfifo_buf_rdata;
							genmcopipe_coproc_custom0_if_resp_genfifo_buf_req = 32'd0;
							genmcopipe_coproc_custom0_if_resp_genfifo_buf_ack = 32'd1;
							end
						end
					gen705_cyclix_genvar = gen704_cyclix_genvar;
					gen70_rtl_var = gen705_cyclix_genvar;
					if (gen70_rtl_var)
						begin
						genpstage_MEM_TRX_BUF[0].genmcopipe_handle_coproc_M_if.rdreq_pending = 32'd0;
						genpstage_MEM_TRX_BUF[0].genmcopipe_handle_coproc_M_if.resp_done = 32'd1;
		...
		// Pipeline flush processing
		gen706_cyclix_genvar = genpstage_MEM_genpctrl_flushreq;
		gen71_rtl_var = gen706_cyclix_genvar;
		if (gen71_rtl_var)
			begin
			genpstage_MEM_genctrl_active = 32'd0;
			end
	...
	gen707_cyclix_genvar = gen399_pipex_var;
	gen72_rtl_var = gen707_cyclix_genvar;
	if (gen72_rtl_var)
		begin
		gen708_cyclix_genvar = genpstage_MEM_genctrl_active;
		gen73_rtl_var = gen708_cyclix_genvar;
		if (gen73_rtl_var)
			begin
			genpsticky_glbl_jump_req_cmd = genpstage_MEM_TRX_LOCAL.jump_req;
			end
		gen709_cyclix_genvar = genpstage_MEM_genctrl_active;
		gen74_rtl_var = gen709_cyclix_genvar;
		if (gen74_rtl_var)
			begin
			genpsticky_glbl_jump_vector_cmd = genpstage_MEM_TRX_LOCAL.jump_vector;
			end
		genpstage_MEM_TRX_LOCAL.jump_req_done = 32'd1;
		gen710_cyclix_genvar = genpstage_MEM_genctrl_active;
		gen75_rtl_var = gen710_cyclix_genvar;
		if (gen75_rtl_var)
			begin
	...
	gen711_cyclix_genvar = gen400_pipex_var;
	gen76_rtl_var = gen711_cyclix_genvar;
	if (gen76_rtl_var)
		begin
		gen401_pipex_var = ~genpstage_MEM_TRX_LOCAL.data_req_done;
		gen402_pipex_var = gen401_pipex_var;
		gen712_cyclix_genvar = gen402_pipex_var;
		gen77_rtl_var = gen712_cyclix_genvar;
		if (gen77_rtl_var)
			begin
			...
			gen713_cyclix_genvar = genpstage_MEM_genctrl_active;
			gen78_rtl_var = gen713_cyclix_genvar;
			if (gen78_rtl_var)
				begin
				gen714_cyclix_genvar = ~genmcopipe_data_mem_full_flag;
				gen715_cyclix_genvar = gen714_cyclix_genvar;
				gen79_rtl_var = gen715_cyclix_genvar;
				if (gen79_rtl_var)
					begin
					...
					if (gen81_rtl_var)
						...
						if (gen83_rtl_var)
							...
							gen716_cyclix_genvar = genmcopipe_data_mem_req_genfifo_ack_i;
							end
						genmcopipe_data_mem_req_genfifo_reqbuf_req = 32'd1;
						end
					gen717_cyclix_genvar = gen716_cyclix_genvar;
					gen84_rtl_var = gen717_cyclix_genvar;
					if (gen84_rtl_var)
						begin
						gen403_pipex_var = 32'd1;
						gen718_cyclix_genvar = !genpstage_MEM_TRX_LOCAL.mem_cmd;
						genpstage_MEM_TRX_BUF[0].genmcopipe_handle_data_mem.rdreq_pending = gen718_cyclix_genvar;
						...
						gen719_cyclix_genvar = genpstage_MEM_TRX_BUF[0].genmcopipe_handle_data_mem.rdreq_pending;
						gen85_rtl_var = gen719_cyclix_genvar;
						if (gen85_rtl_var)
							begin
			...
			gen86_rtl_var = gen720_cyclix_genvar;
			if (gen86_rtl_var)
				begin
		...
		gen721_cyclix_genvar = gen405_pipex_var;
		gen87_rtl_var = gen721_cyclix_genvar;
		if (gen87_rtl_var)
			begin
			gen722_cyclix_genvar = genpstage_MEM_genctrl_active;
			gen88_rtl_var = gen722_cyclix_genvar;
			if (gen88_rtl_var)
				begin
	...
	// Processing of next pstage busyness
	gen723_cyclix_genvar = ~genpstage_WB_genctrl_rdy;
	gen724_cyclix_genvar = gen723_cyclix_genvar;
	gen89_rtl_var = gen724_cyclix_genvar;
	if (gen89_rtl_var)
		begin
		gen725_cyclix_genvar = genpstage_MEM_genctrl_active;
		gen90_rtl_var = gen725_cyclix_genvar;
		if (gen90_rtl_var)
			begin
			genpstage_MEM_genctrl_stalled_glbl = 32'd1;
			end
	...
	// pctrl_finish and pctrl_succ formation
	gen726_cyclix_genvar = genpstage_MEM_genctrl_stalled_glbl;
	gen91_rtl_var = gen726_cyclix_genvar;
	if (gen91_rtl_var)
		begin
		genpstage_MEM_genctrl_finish = 32'd0;
		genpstage_MEM_genctrl_succ = 32'd0;
		end
	gen727_cyclix_genvar = 1'd0;
	gen727_cyclix_genvar = (gen727_cyclix_genvar || gen726_cyclix_genvar);
	gen727_cyclix_genvar = !gen727_cyclix_genvar;
	gen92_rtl_var = gen727_cyclix_genvar;
	if (gen92_rtl_var)
		begin
	...
	// asserting succ signals
	// processing context in case transaction is ready to propagate
	gen728_cyclix_genvar = genpstage_MEM_genctrl_finish;
	gen93_rtl_var = gen728_cyclix_genvar;
	if (gen93_rtl_var)
		begin
		// programming next stage in case transaction is able to propagate
		gen729_cyclix_genvar = genpstage_MEM_genctrl_succ;
		gen94_rtl_var = gen729_cyclix_genvar;
		if (gen94_rtl_var)
			begin
			gen730_cyclix_genvar = genpstage_WB_genctrl_rdy;
			gen95_rtl_var = gen730_cyclix_genvar;
			if (gen95_rtl_var)
				begin
	...
	gen731_cyclix_genvar = ~genpstage_MEM_TRX_BUF_COUNTER_FULL;
	genpstage_MEM_genctrl_rdy = gen731_cyclix_genvar;
	...
	gen732_cyclix_genvar = genpstage_EXEC_genctrl_stalled_glbl;
	gen96_rtl_var = gen732_cyclix_genvar;
	if (gen96_rtl_var)
		begin
		genpstage_EXEC_genctrl_new = 32'd0;
		genpstage_EXEC_genctrl_stalled_glbl = 32'd0;
	...
	gen733_cyclix_genvar = 1'd0;
	gen733_cyclix_genvar = (gen733_cyclix_genvar || gen732_cyclix_genvar);
	gen733_cyclix_genvar = !gen733_cyclix_genvar;
	gen97_rtl_var = gen733_cyclix_genvar;
	if (gen97_rtl_var)
		begin
	...
	gen734_cyclix_genvar = genpstage_EXEC_genctrl_occupied;
	gen98_rtl_var = gen734_cyclix_genvar;
	if (gen98_rtl_var)
		begin
		// Initializing new newaccums descriptors ####
		gen735_cyclix_genvar = genpstage_EXEC_genctrl_new;
		gen99_rtl_var = gen735_cyclix_genvar;
		if (gen99_rtl_var)
			begin
		...
		// Acquiring mcopipe rdata
		gen736_cyclix_genvar = genpstage_EXEC_TRX_BUF[0].genmcopipe_handle_coproc_M_if.rdreq_pending;
		gen100_rtl_var = gen736_cyclix_genvar;
		if (gen100_rtl_var)
			begin
			gen737_cyclix_genvar = (genpstage_EXEC_TRX_BUF[0].genmcopipe_handle_coproc_M_if.if_id == 1'd0);
			gen738_cyclix_genvar = gen737_cyclix_genvar;
			gen101_rtl_var = gen738_cyclix_genvar;
			if (gen101_rtl_var)
				begin
				gen739_cyclix_genvar = (genpstage_EXEC_TRX_BUF[0].genmcopipe_handle_coproc_M_if.tid == genmcopipe_coproc_M_if_rd_ptr);
				gen740_cyclix_genvar = gen739_cyclix_genvar;
				gen102_rtl_var = gen740_cyclix_genvar;
				if (gen102_rtl_var)
					begin
					...
					gen106_rtl_var = gen742_cyclix_genvar;
					if (gen106_rtl_var)
						begin
			...
			gen743_cyclix_genvar = (genpstage_EXEC_TRX_BUF[0].genmcopipe_handle_coproc_M_if.if_id == 1'd1);
			gen744_cyclix_genvar = gen743_cyclix_genvar;
			gen107_rtl_var = gen744_cyclix_genvar;
			if (gen107_rtl_var)
				begin
				gen745_cyclix_genvar = (genpstage_EXEC_TRX_BUF[0].genmcopipe_handle_coproc_M_if.tid == genmcopipe_coproc_custom0_if_rd_ptr);
				gen746_cyclix_genvar = gen745_cyclix_genvar;
				gen108_rtl_var = gen746_cyclix_genvar;
				if (gen108_rtl_var)
					begin
					...
					gen112_rtl_var = gen748_cyclix_genvar;
					if (gen112_rtl_var)
						begin
						genpstage_EXEC_TRX_BUF[0].genmcopipe_handle_coproc_M_if.rdreq_pending = 32'd0;
						genpstage_EXEC_TRX_BUF[0].genmcopipe_handle_coproc_M_if.resp_done = 32'd1;
		...
		// Pipeline flush processing
		gen749_cyclix_genvar = genpstage_EXEC_genpctrl_flushreq;
		gen113_rtl_var = gen749_cyclix_genvar;
		if (gen113_rtl_var)
			begin
			genpstage_EXEC_genctrl_active = 32'd0;
			end
	...
	gen750_cyclix_genvar = gen343_pipex_var;
	gen114_rtl_var = gen750_cyclix_genvar;
	if (gen114_rtl_var)
		begin
		genpstage_EXEC_genctrl_active = 32'd0;
		end
	gen344_pipex_var = genpsticky_glbl_MIRQEN;
	gen751_cyclix_genvar = gen344_pipex_var;
	gen115_rtl_var = gen751_cyclix_genvar;
	if (gen115_rtl_var)
		begin
		gen345_pipex_var = ~genpstage_EXEC_TRX_LOCAL.irq_recv;
		gen346_pipex_var = gen345_pipex_var;
		gen752_cyclix_genvar = gen346_pipex_var;
		gen116_rtl_var = gen752_cyclix_genvar;
		if (gen116_rtl_var)
			begin
			gen753_cyclix_genvar = genpstage_EXEC_genctrl_active;
			gen117_rtl_var = gen753_cyclix_genvar;
			if (gen117_rtl_var)
				begin
				...
				if (gen119_rtl_var)
					...
					if (gen120_rtl_var)
						begin
						gen754_cyclix_genvar = 32'd1;
						genpstage_EXEC_TRX_LOCAL.irq_mcause = irq_fifo_genfifo_buf_rdata;
						irq_fifo_genfifo_buf_req = 32'd0;
						irq_fifo_genfifo_buf_ack = 32'd1;
						end
					end
				gen347_pipex_var = gen754_cyclix_genvar;
				end
			genpstage_EXEC_TRX_LOCAL.irq_recv = gen347_pipex_var;
			gen755_cyclix_genvar = genpstage_EXEC_genctrl_active;
			gen121_rtl_var = gen755_cyclix_genvar;
			if (gen121_rtl_var)
				begin
			...
			gen122_rtl_var = gen756_cyclix_genvar;
			if (gen122_rtl_var)
				begin
		...
		gen757_cyclix_genvar = gen348_pipex_var;
		gen123_rtl_var = gen757_cyclix_genvar;
		if (gen123_rtl_var)
			begin
			...
			gen124_rtl_var = gen758_cyclix_genvar;
			if (gen124_rtl_var)
				begin
				genpsticky_glbl_MIRQEN = 32'd0;
				end
			gen759_cyclix_genvar = genpstage_EXEC_genctrl_active;
			gen125_rtl_var = gen759_cyclix_genvar;
			if (gen125_rtl_var)
				begin
				genpsticky_glbl_CSR_MCAUSE = genpstage_EXEC_TRX_LOCAL.irq_mcause;
				end
			gen760_cyclix_genvar = genpstage_EXEC_genctrl_active;
			gen126_rtl_var = gen760_cyclix_genvar;
			if (gen126_rtl_var)
				begin
	...
	gen127_rtl_var = gen761_cyclix_genvar;
	if (gen127_rtl_var)
		begin
		gen762_cyclix_genvar = genpstage_EXEC_genctrl_active;
		gen128_rtl_var = gen762_cyclix_genvar;
		if (gen128_rtl_var)
			begin
			genpsticky_glbl_MIRQEN = 32'd1;
			end
	...
	gen763_cyclix_genvar = gen351_pipex_var;
	gen129_rtl_var = gen763_cyclix_genvar;
	if (gen129_rtl_var)
		begin
		gen352_pipex_var = genpstage_EXEC_TRX_LOCAL.m_ext_req;
		gen764_cyclix_genvar = gen352_pipex_var;
		gen130_rtl_var = gen764_cyclix_genvar;
		if (gen130_rtl_var)
			begin
			gen765_cyclix_genvar = genpstage_EXEC_genctrl_active;
			gen131_rtl_var = gen765_cyclix_genvar;
			if (gen131_rtl_var)
				begin
				gen766_cyclix_genvar = ~genmcopipe_coproc_M_if_full_flag;
				gen767_cyclix_genvar = gen766_cyclix_genvar;
				gen132_rtl_var = gen767_cyclix_genvar;
				if (gen132_rtl_var)
					begin
					...
					if (gen134_rtl_var)
						...
						if (gen136_rtl_var)
							...
							gen768_cyclix_genvar = genmcopipe_coproc_M_if_req_genfifo_ack_i;
							end
						genmcopipe_coproc_M_if_req_genfifo_reqbuf_req = 32'd1;
						end
					gen769_cyclix_genvar = gen768_cyclix_genvar;
					gen137_rtl_var = gen769_cyclix_genvar;
					if (gen137_rtl_var)
						begin
						gen353_pipex_var = 32'd1;
						gen770_cyclix_genvar = !32'd0;
						genpstage_EXEC_TRX_BUF[0].genmcopipe_handle_coproc_M_if.rdreq_pending = gen770_cyclix_genvar;
						...
						gen138_rtl_var = gen771_cyclix_genvar;
						if (gen138_rtl_var)
							begin
			...
			gen139_rtl_var = gen772_cyclix_genvar;
			if (gen139_rtl_var)
				begin
			...
			gen773_cyclix_genvar = gen355_pipex_var;
			gen140_rtl_var = gen773_cyclix_genvar;
			if (gen140_rtl_var)
				begin
				gen774_cyclix_genvar = genpstage_EXEC_genctrl_active;
				gen141_rtl_var = gen774_cyclix_genvar;
				if (gen141_rtl_var)
					begin
		...
		gen775_cyclix_genvar = gen356_pipex_var;
		gen142_rtl_var = gen775_cyclix_genvar;
		if (gen142_rtl_var)
			begin
			gen776_cyclix_genvar = genpstage_EXEC_genctrl_active;
			gen143_rtl_var = gen776_cyclix_genvar;
			if (gen143_rtl_var)
				begin
				gen777_cyclix_genvar = ~genmcopipe_coproc_custom0_if_full_flag;
				gen778_cyclix_genvar = gen777_cyclix_genvar;
				gen144_rtl_var = gen778_cyclix_genvar;
				if (gen144_rtl_var)
					begin
					...
					if (gen146_rtl_var)
						...
						if (gen148_rtl_var)
							...
							gen779_cyclix_genvar = genmcopipe_coproc_custom0_if_req_genfifo_ack_i;
							end
						genmcopipe_coproc_custom0_if_req_genfifo_reqbuf_req = 32'd1;
						end
					gen780_cyclix_genvar = gen779_cyclix_genvar;
					gen149_rtl_var = gen780_cyclix_genvar;
					if (gen149_rtl_var)
						begin
						gen357_pipex_var = 32'd1;
						gen781_cyclix_genvar = !32'd0;
						genpstage_EXEC_TRX_BUF[0].genmcopipe_handle_coproc_M_if.rdreq_pending = gen781_cyclix_genvar;
						...
						gen782_cyclix_genvar = genpstage_EXEC_TRX_BUF[0].genmcopipe_handle_coproc_M_if.rdreq_pending;
						gen150_rtl_var = gen782_cyclix_genvar;
						if (gen150_rtl_var)
							begin
			...
			gen151_rtl_var = gen783_cyclix_genvar;
			if (gen151_rtl_var)
				begin
			...
			gen784_cyclix_genvar = gen359_pipex_var;
			gen152_rtl_var = gen784_cyclix_genvar;
			if (gen152_rtl_var)
				begin
				gen785_cyclix_genvar = genpstage_EXEC_genctrl_active;
				gen153_rtl_var = gen785_cyclix_genvar;
				if (gen153_rtl_var)
					begin
					genpstage_EXEC_genctrl_stalled_glbl = 32'd1;
					end
	...
	gen786_cyclix_genvar = gen360_pipex_var;
	gen154_rtl_var = gen786_cyclix_genvar;
	if (gen154_rtl_var)
		begin
		...
		gen787_cyclix_genvar = gen385_pipex_var;
		gen155_rtl_var = gen787_cyclix_genvar;
		if (gen155_rtl_var)
			begin
		...
		gen788_cyclix_genvar = gen386_pipex_var;
		gen156_rtl_var = gen788_cyclix_genvar;
		if (gen156_rtl_var)
			begin
	...
	endcase
	gen387_pipex_var = (genpstage_EXEC_TRX_LOCAL.curinstr_addr + genpstage_EXEC_TRX_LOCAL.immediate);
	genpstage_EXEC_TRX_LOCAL.curinstraddr_imm = gen387_pipex_var;
	...
	endcase
	gen388_pipex_var = genpstage_EXEC_TRX_LOCAL.jump_req_cond;
	gen789_cyclix_genvar = gen388_pipex_var;
	gen157_rtl_var = gen789_cyclix_genvar;
	if (gen157_rtl_var)
		begin
		case (genpstage_EXEC_TRX_LOCAL.funct3)
			32'd0:
				begin
				gen389_pipex_var = genpstage_EXEC_TRX_LOCAL.alu_ZF;
				gen790_cyclix_genvar = gen389_pipex_var;
				gen158_rtl_var = gen790_cyclix_genvar;
				if (gen158_rtl_var)
					begin
					genpstage_EXEC_TRX_LOCAL.jump_req = 32'd1;
			...
			32'd1:
				begin
				gen390_pipex_var = ~genpstage_EXEC_TRX_LOCAL.alu_ZF;
				gen391_pipex_var = gen390_pipex_var;
				gen791_cyclix_genvar = gen391_pipex_var;
				gen159_rtl_var = gen791_cyclix_genvar;
				if (gen159_rtl_var)
					begin
					genpstage_EXEC_TRX_LOCAL.jump_req = 32'd1;
					genpstage_EXEC_TRX_LOCAL.jump_vector = genpstage_EXEC_TRX_LOCAL.curinstraddr_imm;
			...
			32'd4:
				begin
				gen392_pipex_var = genpstage_EXEC_TRX_LOCAL.alu_CF;
				gen792_cyclix_genvar = gen392_pipex_var;
				gen160_rtl_var = gen792_cyclix_genvar;
				if (gen160_rtl_var)
					begin
					genpstage_EXEC_TRX_LOCAL.jump_req = 32'd1;
					genpstage_EXEC_TRX_LOCAL.jump_vector = genpstage_EXEC_TRX_LOCAL.curinstraddr_imm;
			...
			32'd5:
				...
				gen793_cyclix_genvar = gen394_pipex_var;
				gen161_rtl_var = gen793_cyclix_genvar;
				if (gen161_rtl_var)
					begin
					genpstage_EXEC_TRX_LOCAL.jump_req = 32'd1;
					genpstage_EXEC_TRX_LOCAL.jump_vector = genpstage_EXEC_TRX_LOCAL.curinstraddr_imm;
			...
			32'd6:
				begin
				gen395_pipex_var = genpstage_EXEC_TRX_LOCAL.alu_CF;
				gen794_cyclix_genvar = gen395_pipex_var;
				gen162_rtl_var = gen794_cyclix_genvar;
				if (gen162_rtl_var)
					begin
					genpstage_EXEC_TRX_LOCAL.jump_req = 32'd1;
					genpstage_EXEC_TRX_LOCAL.jump_vector = genpstage_EXEC_TRX_LOCAL.curinstraddr_imm;
			...
			32'd7:
				begin
				gen396_pipex_var = ~genpstage_EXEC_TRX_LOCAL.alu_CF;
				gen397_pipex_var = gen396_pipex_var;
				gen795_cyclix_genvar = gen397_pipex_var;
				gen163_rtl_var = gen795_cyclix_genvar;
				if (gen163_rtl_var)
					begin
					genpstage_EXEC_TRX_LOCAL.jump_req = 32'd1;
					genpstage_EXEC_TRX_LOCAL.jump_vector = genpstage_EXEC_TRX_LOCAL.curinstraddr_imm;
	...
	// Processing of next pstage busyness
	gen796_cyclix_genvar = ~genpstage_MEM_genctrl_rdy;
	gen797_cyclix_genvar = gen796_cyclix_genvar;
	gen164_rtl_var = gen797_cyclix_genvar;
	if (gen164_rtl_var)
		begin
		gen798_cyclix_genvar = genpstage_EXEC_genctrl_active;
		gen165_rtl_var = gen798_cyclix_genvar;
		if (gen165_rtl_var)
			begin
			genpstage_EXEC_genctrl_stalled_glbl = 32'd1;
			end
	...
	// pctrl_finish and pctrl_succ formation
	gen799_cyclix_genvar = genpstage_EXEC_genctrl_stalled_glbl;
	gen166_rtl_var = gen799_cyclix_genvar;
	if (gen166_rtl_var)
		begin
		genpstage_EXEC_genctrl_finish = 32'd0;
		genpstage_EXEC_genctrl_succ = 32'd0;
		end
	gen800_cyclix_genvar = 1'd0;
	gen800_cyclix_genvar = (gen800_cyclix_genvar || gen799_cyclix_genvar);
	gen800_cyclix_genvar = !gen800_cyclix_genvar;
	gen167_rtl_var = gen800_cyclix_genvar;
	if (gen167_rtl_var)
		begin
	...
	// asserting succ signals
	// processing context in case transaction is ready to propagate
	gen801_cyclix_genvar = genpstage_EXEC_genctrl_finish;
	gen168_rtl_var = gen801_cyclix_genvar;
	if (gen168_rtl_var)
		begin
		// programming next stage in case transaction is able to propagate
		gen802_cyclix_genvar = genpstage_EXEC_genctrl_succ;
		gen169_rtl_var = gen802_cyclix_genvar;
		if (gen169_rtl_var)
			begin
			gen803_cyclix_genvar = genpstage_MEM_genctrl_rdy;
			gen170_rtl_var = gen803_cyclix_genvar;
			if (gen170_rtl_var)
				begin
				// propagating transaction context
	...
	gen804_cyclix_genvar = ~genpstage_EXEC_TRX_BUF_COUNTER_FULL;
	genpstage_EXEC_genctrl_rdy = gen804_cyclix_genvar;
	...
	gen805_cyclix_genvar = genpstage_IDECODE_genctrl_stalled_glbl;
	gen171_rtl_var = gen805_cyclix_genvar;
	if (gen171_rtl_var)
		begin
		genpstage_IDECODE_genctrl_new = 32'd0;
		genpstage_IDECODE_genctrl_stalled_glbl = 32'd0;
	...
	gen806_cyclix_genvar = 1'd0;
	gen806_cyclix_genvar = (gen806_cyclix_genvar || gen805_cyclix_genvar);
	gen806_cyclix_genvar = !gen806_cyclix_genvar;
	gen172_rtl_var = gen806_cyclix_genvar;
	if (gen172_rtl_var)
		begin
	...
	gen807_cyclix_genvar = genpstage_IDECODE_genctrl_occupied;
	gen173_rtl_var = gen807_cyclix_genvar;
	if (gen173_rtl_var)
		begin
		// Initializing new newaccums descriptors ####
		gen808_cyclix_genvar = genpstage_IDECODE_genctrl_new;
		gen174_rtl_var = gen808_cyclix_genvar;
		if (gen174_rtl_var)
			begin
		...
		// Acquiring mcopipe rdata
		gen809_cyclix_genvar = genpstage_IDECODE_TRX_BUF[0].genmcopipe_handle_instr_mem.rdreq_pending;
		gen175_rtl_var = gen809_cyclix_genvar;
		if (gen175_rtl_var)
			begin
			gen810_cyclix_genvar = (genpstage_IDECODE_TRX_BUF[0].genmcopipe_handle_instr_mem.if_id == 1'd0);
			gen811_cyclix_genvar = gen810_cyclix_genvar;
			gen176_rtl_var = gen811_cyclix_genvar;
			if (gen176_rtl_var)
				begin
				gen812_cyclix_genvar = (genpstage_IDECODE_TRX_BUF[0].genmcopipe_handle_instr_mem.tid == genmcopipe_instr_mem_rd_ptr);
				gen813_cyclix_genvar = gen812_cyclix_genvar;
				gen177_rtl_var = gen813_cyclix_genvar;
				if (gen177_rtl_var)
					begin
					...
					gen181_rtl_var = gen815_cyclix_genvar;
					if (gen181_rtl_var)
						begin
		...
		// Pipeline flush processing
		gen816_cyclix_genvar = genpstage_IDECODE_genpctrl_flushreq;
		gen182_rtl_var = gen816_cyclix_genvar;
		if (gen182_rtl_var)
			begin
			genpstage_IDECODE_genctrl_active = 32'd0;
			end
	...
	gen817_cyclix_genvar = gen227_pipex_var;
	gen183_rtl_var = gen817_cyclix_genvar;
	if (gen183_rtl_var)
		begin
		genpstage_IDECODE_genctrl_active = 32'd0;
		end
	gen818_cyclix_genvar = genpstage_IDECODE_TRX_BUF[0].genmcopipe_handle_instr_mem.resp_done;
	gen184_rtl_var = gen818_cyclix_genvar;
	if (gen184_rtl_var)
		begin
	...
	gen819_cyclix_genvar = gen230_pipex_var;
	gen185_rtl_var = gen819_cyclix_genvar;
	if (gen185_rtl_var)
		begin
		gen820_cyclix_genvar = genpstage_IDECODE_genctrl_active;
		gen186_rtl_var = gen820_cyclix_genvar;
		if (gen186_rtl_var)
			begin
	...
	case (genpstage_IDECODE_TRX_LOCAL.opcode)
		...
		32'd99:
			...
			gen821_cyclix_genvar = gen247_pipex_var;
			gen187_rtl_var = gen821_cyclix_genvar;
			if (gen187_rtl_var)
				begin
		...
		32'd19:
			...
			case (genpstage_IDECODE_TRX_LOCAL.funct3)
				...
				32'd5:
					...
					gen822_cyclix_genvar = gen249_pipex_var;
					gen188_rtl_var = gen822_cyclix_genvar;
					if (gen188_rtl_var)
						begin
					...
					gen823_cyclix_genvar = gen250_pipex_var;
					gen189_rtl_var = gen823_cyclix_genvar;
					if (gen189_rtl_var)
						begin
		...
		32'd51:
			...
			case (genpstage_IDECODE_TRX_LOCAL.funct3)
				32'd0:
					...
					gen190_rtl_var = gen824_cyclix_genvar;
					if (gen190_rtl_var)
						begin
						genpstage_IDECODE_TRX_LOCAL.alu_opcode = 32'd1;
						end
					...
					gen191_rtl_var = gen825_cyclix_genvar;
					if (gen191_rtl_var)
						begin
						genpstage_IDECODE_TRX_LOCAL.alu_opcode = 32'd0;
						end
				...
				32'd5:
					...
					gen826_cyclix_genvar = gen254_pipex_var;
					gen192_rtl_var = gen826_cyclix_genvar;
					if (gen192_rtl_var)
						begin
						genpstage_IDECODE_TRX_LOCAL.alu_opcode = 32'd6;
						end
					...
					gen827_cyclix_genvar = gen255_pipex_var;
					gen193_rtl_var = gen827_cyclix_genvar;
					if (gen193_rtl_var)
						begin
						genpstage_IDECODE_TRX_LOCAL.alu_opcode = 32'd5;
						end
			...
			gen194_rtl_var = gen828_cyclix_genvar;
			if (gen194_rtl_var)
				begin
		...
		32'd115:
			...
			case (genpstage_IDECODE_TRX_LOCAL.funct3)
				32'd0:
					...
					gen829_cyclix_genvar = gen258_pipex_var;
					gen195_rtl_var = gen829_cyclix_genvar;
					if (gen195_rtl_var)
						begin
					...
					gen830_cyclix_genvar = gen259_pipex_var;
					gen196_rtl_var = gen830_cyclix_genvar;
					if (gen196_rtl_var)
						begin
	...
	gen831_cyclix_genvar = gen263_pipex_var;
	gen197_rtl_var = gen831_cyclix_genvar;
	if (gen197_rtl_var)
		begin
		case (genpstage_IDECODE_TRX_LOCAL.funct3)
			32'd0:
	...
	gen832_cyclix_genvar = gen265_pipex_var;
	gen198_rtl_var = gen832_cyclix_genvar;
	if (gen198_rtl_var)
		begin
	...
	gen833_cyclix_genvar = gen267_pipex_var;
	gen199_rtl_var = gen833_cyclix_genvar;
	if (gen199_rtl_var)
		begin
		genpstage_IDECODE_TRX_LOCAL.rd_req = 32'd0;
		end
	gen268_pipex_var[1] = gen834_cyclix_genvar[1];
	gen268_pipex_var[2] = gen834_cyclix_genvar[2];
	gen268_pipex_var[3] = gen834_cyclix_genvar[3];
	gen268_pipex_var[4] = gen834_cyclix_genvar[4];
	gen268_pipex_var[5] = gen834_cyclix_genvar[5];
	gen268_pipex_var[6] = gen834_cyclix_genvar[6];
	gen268_pipex_var[7] = gen834_cyclix_genvar[7];
	gen268_pipex_var[8] = gen834_cyclix_genvar[8];
	gen268_pipex_var[9] = gen834_cyclix_genvar[9];
	gen268_pipex_var[10] = gen834_cyclix_genvar[10];
	gen268_pipex_var[11] = gen834_cyclix_genvar[11];
	gen268_pipex_var[12] = gen834_cyclix_genvar[12];
	gen268_pipex_var[13] = gen834_cyclix_genvar[13];
	gen268_pipex_var[14] = gen834_cyclix_genvar[14];
	gen268_pipex_var[15] = gen834_cyclix_genvar[15];
	gen268_pipex_var[16] = gen834_cyclix_genvar[16];
	gen268_pipex_var[17] = gen834_cyclix_genvar[17];
	gen268_pipex_var[18] = gen834_cyclix_genvar[18];
	gen268_pipex_var[19] = gen834_cyclix_genvar[19];
	gen268_pipex_var[20] = gen834_cyclix_genvar[20];
	gen268_pipex_var[21] = gen834_cyclix_genvar[21];
	gen268_pipex_var[22] = gen834_cyclix_genvar[22];
	gen268_pipex_var[23] = gen834_cyclix_genvar[23];
	gen268_pipex_var[24] = gen834_cyclix_genvar[24];
	gen268_pipex_var[25] = gen834_cyclix_genvar[25];
	gen268_pipex_var[26] = gen834_cyclix_genvar[26];
	gen268_pipex_var[27] = gen834_cyclix_genvar[27];
	gen268_pipex_var[28] = gen834_cyclix_genvar[28];
	gen268_pipex_var[29] = gen834_cyclix_genvar[29];
	gen268_pipex_var[30] = gen834_cyclix_genvar[30];
	gen268_pipex_var[31] = gen834_cyclix_genvar[31];
	genpstage_IDECODE_TRX_LOCAL.rs1_rdata = gen268_pipex_var[genpstage_IDECODE_TRX_LOCAL.rs1_addr];
	gen269_pipex_var[1] = gen834_cyclix_genvar[1];
	gen269_pipex_var[2] = gen834_cyclix_genvar[2];
	gen269_pipex_var[3] = gen834_cyclix_genvar[3];
	gen269_pipex_var[4] = gen834_cyclix_genvar[4];
	gen269_pipex_var[5] = gen834_cyclix_genvar[5];
	gen269_pipex_var[6] = gen834_cyclix_genvar[6];
	gen269_pipex_var[7] = gen834_cyclix_genvar[7];
	gen269_pipex_var[8] = gen834_cyclix_genvar[8];
	gen269_pipex_var[9] = gen834_cyclix_genvar[9];
	gen269_pipex_var[10] = gen834_cyclix_genvar[10];
	gen269_pipex_var[11] = gen834_cyclix_genvar[11];
	gen269_pipex_var[12] = gen834_cyclix_genvar[12];
	gen269_pipex_var[13] = gen834_cyclix_genvar[13];
	gen269_pipex_var[14] = gen834_cyclix_genvar[14];
	gen269_pipex_var[15] = gen834_cyclix_genvar[15];
	gen269_pipex_var[16] = gen834_cyclix_genvar[16];
	gen269_pipex_var[17] = gen834_cyclix_genvar[17];
	gen269_pipex_var[18] = gen834_cyclix_genvar[18];
	gen269_pipex_var[19] = gen834_cyclix_genvar[19];
	gen269_pipex_var[20] = gen834_cyclix_genvar[20];
	gen269_pipex_var[21] = gen834_cyclix_genvar[21];
	gen269_pipex_var[22] = gen834_cyclix_genvar[22];
	gen269_pipex_var[23] = gen834_cyclix_genvar[23];
	gen269_pipex_var[24] = gen834_cyclix_genvar[24];
	gen269_pipex_var[25] = gen834_cyclix_genvar[25];
	gen269_pipex_var[26] = gen834_cyclix_genvar[26];
	gen269_pipex_var[27] = gen834_cyclix_genvar[27];
	gen269_pipex_var[28] = gen834_cyclix_genvar[28];
	gen269_pipex_var[29] = gen834_cyclix_genvar[29];
	gen269_pipex_var[30] = gen834_cyclix_genvar[30];
	gen269_pipex_var[31] = gen834_cyclix_genvar[31];
	...
	gen835_cyclix_genvar = gen271_pipex_var;
	gen200_rtl_var = gen835_cyclix_genvar;
	if (gen200_rtl_var)
		begin
	...
	gen836_cyclix_genvar = gen273_pipex_var;
	gen201_rtl_var = gen836_cyclix_genvar;
	if (gen201_rtl_var)
		begin
		genpstage_IDECODE_TRX_LOCAL.rs2_rdata = 32'd0;
		end
	gen274_pipex_var = genpstage_IDECODE_TRX_LOCAL.csrreq;
	gen837_cyclix_genvar = gen274_pipex_var;
	gen202_rtl_var = gen837_cyclix_genvar;
	if (gen202_rtl_var)
		begin
	...
	gen838_cyclix_genvar = gen278_pipex_var;
	gen203_rtl_var = gen838_cyclix_genvar;
	if (gen203_rtl_var)
		begin
		gen279_pipex_var = genpstage_IDECODE_TRX_LOCAL.rs1_req;
		gen839_cyclix_genvar = gen279_pipex_var;
		gen204_rtl_var = gen839_cyclix_genvar;
		if (gen204_rtl_var)
			begin
			...
			if (gen205_rtl_var)
				...
				if (gen206_rtl_var)
					...
					gen207_rtl_var = gen842_cyclix_genvar;
					if (gen207_rtl_var)
						begin
				...
				gen843_cyclix_genvar = gen286_pipex_var;
				gen208_rtl_var = gen843_cyclix_genvar;
				if (gen208_rtl_var)
					begin
					gen844_cyclix_genvar = genpstage_IDECODE_genctrl_active;
					gen209_rtl_var = gen844_cyclix_genvar;
					if (gen209_rtl_var)
						begin
						genpstage_IDECODE_genctrl_stalled_glbl = 32'd1;
						end
		...
		gen845_cyclix_genvar = gen287_pipex_var;
		gen210_rtl_var = gen845_cyclix_genvar;
		if (gen210_rtl_var)
			begin
			...
			if (gen211_rtl_var)
				...
				if (gen212_rtl_var)
					...
					gen213_rtl_var = gen848_cyclix_genvar;
					if (gen213_rtl_var)
						begin
				...
				gen849_cyclix_genvar = gen294_pipex_var;
				gen214_rtl_var = gen849_cyclix_genvar;
				if (gen214_rtl_var)
					begin
					gen850_cyclix_genvar = genpstage_IDECODE_genctrl_active;
					gen215_rtl_var = gen850_cyclix_genvar;
					if (gen215_rtl_var)
						begin
						genpstage_IDECODE_genctrl_stalled_glbl = 32'd1;
						end
	...
	gen851_cyclix_genvar = gen298_pipex_var;
	gen216_rtl_var = gen851_cyclix_genvar;
	if (gen216_rtl_var)
		begin
		gen299_pipex_var = genpstage_IDECODE_TRX_LOCAL.rs1_req;
		gen852_cyclix_genvar = gen299_pipex_var;
		gen217_rtl_var = gen852_cyclix_genvar;
		if (gen217_rtl_var)
			begin
			...
			if (gen218_rtl_var)
				...
				if (gen219_rtl_var)
					...
					gen220_rtl_var = gen855_cyclix_genvar;
					if (gen220_rtl_var)
						begin
				...
				gen856_cyclix_genvar = gen306_pipex_var;
				gen221_rtl_var = gen856_cyclix_genvar;
				if (gen221_rtl_var)
					begin
					gen857_cyclix_genvar = genpstage_IDECODE_genctrl_active;
					gen222_rtl_var = gen857_cyclix_genvar;
					if (gen222_rtl_var)
						begin
						genpstage_IDECODE_genctrl_stalled_glbl = 32'd1;
						end
		...
		gen858_cyclix_genvar = gen307_pipex_var;
		gen223_rtl_var = gen858_cyclix_genvar;
		if (gen223_rtl_var)
			begin
			...
			if (gen224_rtl_var)
				...
				if (gen225_rtl_var)
					...
					gen226_rtl_var = gen861_cyclix_genvar;
					if (gen226_rtl_var)
						begin
				...
				gen862_cyclix_genvar = gen314_pipex_var;
				gen227_rtl_var = gen862_cyclix_genvar;
				if (gen227_rtl_var)
					begin
					gen863_cyclix_genvar = genpstage_IDECODE_genctrl_active;
					gen228_rtl_var = gen863_cyclix_genvar;
					if (gen228_rtl_var)
						begin
						genpstage_IDECODE_genctrl_stalled_glbl = 32'd1;
						end
	...
	gen864_cyclix_genvar = gen318_pipex_var;
	gen229_rtl_var = gen864_cyclix_genvar;
	if (gen229_rtl_var)
		begin
		gen319_pipex_var = genpstage_IDECODE_TRX_LOCAL.rs1_req;
		gen865_cyclix_genvar = gen319_pipex_var;
		gen230_rtl_var = gen865_cyclix_genvar;
		if (gen230_rtl_var)
			begin
			...
			if (gen231_rtl_var)
				...
				if (gen232_rtl_var)
					...
					gen233_rtl_var = gen868_cyclix_genvar;
					if (gen233_rtl_var)
						begin
				...
				gen869_cyclix_genvar = gen326_pipex_var;
				gen234_rtl_var = gen869_cyclix_genvar;
				if (gen234_rtl_var)
					begin
					gen870_cyclix_genvar = genpstage_IDECODE_genctrl_active;
					gen235_rtl_var = gen870_cyclix_genvar;
					if (gen235_rtl_var)
						begin
						genpstage_IDECODE_genctrl_stalled_glbl = 32'd1;
						end
		...
		gen871_cyclix_genvar = gen327_pipex_var;
		gen236_rtl_var = gen871_cyclix_genvar;
		if (gen236_rtl_var)
			begin
			...
			if (gen237_rtl_var)
				...
				if (gen238_rtl_var)
					...
					gen239_rtl_var = gen874_cyclix_genvar;
					if (gen239_rtl_var)
						begin
				...
				gen875_cyclix_genvar = gen334_pipex_var;
				gen240_rtl_var = gen875_cyclix_genvar;
				if (gen240_rtl_var)
					begin
					gen876_cyclix_genvar = genpstage_IDECODE_genctrl_active;
					gen241_rtl_var = gen876_cyclix_genvar;
					if (gen241_rtl_var)
						begin
						genpstage_IDECODE_genctrl_stalled_glbl = 32'd1;
						end
	...
	gen877_cyclix_genvar = gen335_pipex_var;
	gen242_rtl_var = gen877_cyclix_genvar;
	if (gen242_rtl_var)
		begin
	...
	gen878_cyclix_genvar = gen338_pipex_var;
	gen243_rtl_var = gen878_cyclix_genvar;
	if (gen243_rtl_var)
		begin
	...
	// Processing of next pstage busyness
	gen879_cyclix_genvar = ~genpstage_EXEC_genctrl_rdy;
	gen880_cyclix_genvar = gen879_cyclix_genvar;
	gen244_rtl_var = gen880_cyclix_genvar;
	if (gen244_rtl_var)
		begin
		gen881_cyclix_genvar = genpstage_IDECODE_genctrl_active;
		gen245_rtl_var = gen881_cyclix_genvar;
		if (gen245_rtl_var)
			begin
			genpstage_IDECODE_genctrl_stalled_glbl = 32'd1;
			end
	...
	// pctrl_finish and pctrl_succ formation
	gen882_cyclix_genvar = genpstage_IDECODE_genctrl_stalled_glbl;
	gen246_rtl_var = gen882_cyclix_genvar;
	if (gen246_rtl_var)
		begin
		genpstage_IDECODE_genctrl_finish = 32'd0;
		genpstage_IDECODE_genctrl_succ = 32'd0;
		end
	gen883_cyclix_genvar = 1'd0;
	gen883_cyclix_genvar = (gen883_cyclix_genvar || gen882_cyclix_genvar);
	gen883_cyclix_genvar = !gen883_cyclix_genvar;
	gen247_rtl_var = gen883_cyclix_genvar;
	if (gen247_rtl_var)
		begin
	...
	// asserting succ signals
	// processing context in case transaction is ready to propagate
	gen884_cyclix_genvar = genpstage_IDECODE_genctrl_finish;
	gen248_rtl_var = gen884_cyclix_genvar;
	if (gen248_rtl_var)
		begin
		// programming next stage in case transaction is able to propagate
		gen885_cyclix_genvar = genpstage_IDECODE_genctrl_succ;
		gen249_rtl_var = gen885_cyclix_genvar;
		if (gen249_rtl_var)
			begin
			gen886_cyclix_genvar = genpstage_EXEC_genctrl_rdy;
			gen250_rtl_var = gen886_cyclix_genvar;
			if (gen250_rtl_var)
				begin
				// propagating transaction context
	...
	gen887_cyclix_genvar = ~genpstage_IDECODE_TRX_BUF_COUNTER_FULL;
	genpstage_IDECODE_genctrl_rdy = gen887_cyclix_genvar;
	...
	gen888_cyclix_genvar = genpstage_IFETCH_genctrl_stalled_glbl;
	gen251_rtl_var = gen888_cyclix_genvar;
	if (gen251_rtl_var)
		begin
		genpstage_IFETCH_genctrl_new = 32'd0;
		genpstage_IFETCH_genctrl_stalled_glbl = 32'd0;
	...
	gen889_cyclix_genvar = 1'd0;
	gen889_cyclix_genvar = (gen889_cyclix_genvar || gen888_cyclix_genvar);
	gen889_cyclix_genvar = !gen889_cyclix_genvar;
	gen252_rtl_var = gen889_cyclix_genvar;
	if (gen252_rtl_var)
		begin
		genpstage_IFETCH_genctrl_active = 32'd1;
	...
	gen890_cyclix_genvar = genpstage_IFETCH_genctrl_occupied;
	gen253_rtl_var = gen890_cyclix_genvar;
	if (gen253_rtl_var)
		begin
		// Initializing new newaccums descriptors ####
		gen891_cyclix_genvar = genpstage_IFETCH_genctrl_new;
		gen254_rtl_var = gen891_cyclix_genvar;
		if (gen254_rtl_var)
			begin
		...
		// Acquiring mcopipe rdata
		gen892_cyclix_genvar = genpstage_IFETCH_TRX_BUF[0].genmcopipe_handle_instr_mem.rdreq_pending;
		gen255_rtl_var = gen892_cyclix_genvar;
		if (gen255_rtl_var)
			begin
			gen893_cyclix_genvar = (genpstage_IFETCH_TRX_BUF[0].genmcopipe_handle_instr_mem.if_id == 1'd0);
			gen894_cyclix_genvar = gen893_cyclix_genvar;
			gen256_rtl_var = gen894_cyclix_genvar;
			if (gen256_rtl_var)
				begin
				gen895_cyclix_genvar = (genpstage_IFETCH_TRX_BUF[0].genmcopipe_handle_instr_mem.tid == genmcopipe_instr_mem_rd_ptr);
				gen896_cyclix_genvar = gen895_cyclix_genvar;
				gen257_rtl_var = gen896_cyclix_genvar;
				if (gen257_rtl_var)
					begin
					...
					if (gen259_rtl_var)
						...
						if (gen260_rtl_var)
							begin
							gen897_cyclix_genvar = 32'd1;
							gen448_pipex_mcopipe_rdata = genmcopipe_instr_mem_resp_genfifo_buf_rdata;
							genmcopipe_instr_mem_resp_genfifo_buf_req = 32'd0;
							genmcopipe_instr_mem_resp_genfifo_buf_ack = 32'd1;
							end
						end
					gen898_cyclix_genvar = gen897_cyclix_genvar;
					gen261_rtl_var = gen898_cyclix_genvar;
					if (gen261_rtl_var)
						begin
		...
		// Pipeline flush processing
		gen899_cyclix_genvar = genpstage_IFETCH_genpctrl_flushreq;
		gen262_rtl_var = gen899_cyclix_genvar;
		if (gen262_rtl_var)
			begin
			end
		end
	...
	gen900_cyclix_genvar = gen219_pipex_var;
	gen263_rtl_var = gen900_cyclix_genvar;
	if (gen263_rtl_var)
		begin
		gen901_cyclix_genvar = genpstage_IFETCH_genctrl_active;
		gen264_rtl_var = gen901_cyclix_genvar;
		if (gen264_rtl_var)
			begin
			genpsticky_glbl_pc = genpsticky_glbl_jump_vector_cmd;
			end
		gen902_cyclix_genvar = genpstage_IFETCH_genctrl_active;
		gen265_rtl_var = gen902_cyclix_genvar;
		if (gen265_rtl_var)
			begin
			genpsticky_glbl_jump_req_cmd = 32'd0;
			end
	...
	gen220_pipex_var = (genpstage_IFETCH_TRX_LOCAL.curinstr_addr + 32'd4);
	genpstage_IFETCH_TRX_LOCAL.nextinstr_addr = gen220_pipex_var;
	gen217_pipex_succreq = 32'd1;
	gen218_pipex_succbuf = genpstage_IFETCH_TRX_LOCAL.nextinstr_addr;
	gen221_pipex_var = genpsticky_glbl_jump_req_cmd;
	gen903_cyclix_genvar = gen221_pipex_var;
	gen266_rtl_var = gen903_cyclix_genvar;
	if (gen266_rtl_var)
		begin
		genpstage_IFETCH_TRX_LOCAL.instr_req_done = 32'd0;
		gen904_cyclix_genvar = genpstage_IFETCH_genctrl_active;
		gen267_rtl_var = gen904_cyclix_genvar;
		if (gen267_rtl_var)
			begin
			genpstage_IFETCH_TRX_BUF[0].instr_req_done = 32'd0;
			end
	...
	gen905_cyclix_genvar = gen223_pipex_var;
	gen268_rtl_var = gen905_cyclix_genvar;
	if (gen268_rtl_var)
		begin
		gen906_cyclix_genvar = genpstage_IFETCH_genctrl_active;
		gen269_rtl_var = gen906_cyclix_genvar;
		if (gen269_rtl_var)
			begin
			gen907_cyclix_genvar = ~genmcopipe_instr_mem_full_flag;
			gen908_cyclix_genvar = gen907_cyclix_genvar;
			gen270_rtl_var = gen908_cyclix_genvar;
			if (gen270_rtl_var)
				begin
				gen449_pipex_req_struct.we = 1'd0;
				gen449_pipex_req_struct.wdata = genpstage_IFETCH_TRX_LOCAL.instr_busreq;
				gen271_rtl_var = !rst_i;
				gen272_rtl_var = gen271_rtl_var;
				if (gen272_rtl_var)
					begin
					genmcopipe_instr_mem_req_genfifo_req_o = 32'd1;
					gen273_rtl_var = genmcopipe_instr_mem_req_genfifo_reqbuf_req;
					if (gen273_rtl_var)
						begin
						gen909_cyclix_genvar = 32'd0;
						end
					gen274_rtl_var = 1'd0;
					gen274_rtl_var = (gen274_rtl_var || gen273_rtl_var);
					gen274_rtl_var = !gen274_rtl_var;
					if (gen274_rtl_var)
						begin
						genmcopipe_instr_mem_req_genfifo_wdata_bo = gen449_pipex_req_struct;
						gen909_cyclix_genvar = genmcopipe_instr_mem_req_genfifo_ack_i;
						end
					genmcopipe_instr_mem_req_genfifo_reqbuf_req = 32'd1;
					end
				gen910_cyclix_genvar = gen909_cyclix_genvar;
				gen275_rtl_var = gen910_cyclix_genvar;
				if (gen275_rtl_var)
					begin
					gen224_pipex_var = 32'd1;
					gen911_cyclix_genvar = !1'd0;
					genpstage_IFETCH_TRX_BUF[0].genmcopipe_handle_instr_mem.rdreq_pending = gen911_cyclix_genvar;
					...
					gen912_cyclix_genvar = genpstage_IFETCH_TRX_BUF[0].genmcopipe_handle_instr_mem.rdreq_pending;
					gen276_rtl_var = gen912_cyclix_genvar;
					if (gen276_rtl_var)
						begin
		...
		gen913_cyclix_genvar = genpstage_IFETCH_genctrl_active;
		gen277_rtl_var = gen913_cyclix_genvar;
		if (gen277_rtl_var)
			begin
	...
	gen914_cyclix_genvar = gen226_pipex_var;
	gen278_rtl_var = gen914_cyclix_genvar;
	if (gen278_rtl_var)
		begin
		gen915_cyclix_genvar = genpstage_IFETCH_genctrl_active;
		gen279_rtl_var = gen915_cyclix_genvar;
		if (gen279_rtl_var)
			begin
	...
	// Processing of next pstage busyness
	gen916_cyclix_genvar = ~genpstage_IDECODE_genctrl_rdy;
	gen917_cyclix_genvar = gen916_cyclix_genvar;
	gen280_rtl_var = gen917_cyclix_genvar;
	if (gen280_rtl_var)
		begin
		gen918_cyclix_genvar = genpstage_IFETCH_genctrl_active;
		gen281_rtl_var = gen918_cyclix_genvar;
		if (gen281_rtl_var)
			begin
			genpstage_IFETCH_genctrl_stalled_glbl = 32'd1;
			end
	...
	// pctrl_finish and pctrl_succ formation
	gen919_cyclix_genvar = genpstage_IFETCH_genctrl_stalled_glbl;
	gen282_rtl_var = gen919_cyclix_genvar;
	if (gen282_rtl_var)
		begin
		genpstage_IFETCH_genctrl_finish = 32'd0;
		genpstage_IFETCH_genctrl_succ = 32'd0;
		end
	gen920_cyclix_genvar = 1'd0;
	gen920_cyclix_genvar = (gen920_cyclix_genvar || gen919_cyclix_genvar);
	gen920_cyclix_genvar = !gen920_cyclix_genvar;
	gen283_rtl_var = gen920_cyclix_genvar;
	if (gen283_rtl_var)
		begin
	...
	gen284_rtl_var = gen921_cyclix_genvar;
	if (gen284_rtl_var)
		begin
		gen922_cyclix_genvar = gen217_pipex_succreq;
		gen285_rtl_var = gen922_cyclix_genvar;
		if (gen285_rtl_var)
			begin
	...
	// processing context in case transaction is ready to propagate
	gen923_cyclix_genvar = genpstage_IFETCH_genctrl_finish;
	gen286_rtl_var = gen923_cyclix_genvar;
	if (gen286_rtl_var)
		begin
		// programming next stage in case transaction is able to propagate
		gen924_cyclix_genvar = genpstage_IFETCH_genctrl_succ;
		gen287_rtl_var = gen924_cyclix_genvar;
		if (gen287_rtl_var)
			begin
			gen925_cyclix_genvar = genpstage_IDECODE_genctrl_rdy;
			gen288_rtl_var = gen925_cyclix_genvar;
			if (gen288_rtl_var)
				begin
				// propagating transaction context
	...
	gen926_cyclix_genvar = ~genpstage_IFETCH_TRX_BUF_COUNTER_FULL;
	genpstage_IFETCH_genctrl_rdy = gen926_cyclix_genvar;
	genpstage_IFETCH_genctrl_working = (genpstage_IFETCH_genctrl_succ | genpstage_IFETCH_genctrl_stalled_glbl);
	gen927_cyclix_genvar = genmcopipe_instr_mem_rd_done;
	gen289_rtl_var = gen927_cyclix_genvar;
	if (gen289_rtl_var)
		begin
		...
		gen290_rtl_var = gen929_cyclix_genvar;
		if (gen290_rtl_var)
			begin
			genmcopipe_instr_mem_empty_flag = 32'd1;
			end
		end
	gen930_cyclix_genvar = genmcopipe_instr_mem_wr_done;
	gen291_rtl_var = gen930_cyclix_genvar;
	if (gen291_rtl_var)
		begin
		genmcopipe_instr_mem_wr_ptr = genmcopipe_instr_mem_wr_ptr_next;
		genmcopipe_instr_mem_empty_flag = 32'd0;
		gen931_cyclix_genvar = (genmcopipe_instr_mem_rd_ptr == genmcopipe_instr_mem_wr_ptr);
		gen932_cyclix_genvar = gen931_cyclix_genvar;
		gen292_rtl_var = gen932_cyclix_genvar;
		if (gen292_rtl_var)
			begin
			genmcopipe_instr_mem_full_flag = 32'd1;
			end
		end
	gen933_cyclix_genvar = genmcopipe_data_mem_rd_done;
	gen293_rtl_var = gen933_cyclix_genvar;
	if (gen293_rtl_var)
		begin
		...
		gen294_rtl_var = gen935_cyclix_genvar;
		if (gen294_rtl_var)
			begin
			genmcopipe_data_mem_empty_flag = 32'd1;
			end
		end
	gen936_cyclix_genvar = genmcopipe_data_mem_wr_done;
	gen295_rtl_var = gen936_cyclix_genvar;
	if (gen295_rtl_var)
		begin
		genmcopipe_data_mem_wr_ptr = genmcopipe_data_mem_wr_ptr_next;
		genmcopipe_data_mem_empty_flag = 32'd0;
		gen937_cyclix_genvar = (genmcopipe_data_mem_rd_ptr == genmcopipe_data_mem_wr_ptr);
		gen938_cyclix_genvar = gen937_cyclix_genvar;
		gen296_rtl_var = gen938_cyclix_genvar;
		if (gen296_rtl_var)
			begin
			genmcopipe_data_mem_full_flag = 32'd1;
			end
		end
	gen939_cyclix_genvar = genmcopipe_coproc_M_if_rd_done;
	gen297_rtl_var = gen939_cyclix_genvar;
	if (gen297_rtl_var)
		begin
		...
		gen298_rtl_var = gen941_cyclix_genvar;
		if (gen298_rtl_var)
			begin
			genmcopipe_coproc_M_if_empty_flag = 32'd1;
			end
		end
	gen942_cyclix_genvar = genmcopipe_coproc_M_if_wr_done;
	gen299_rtl_var = gen942_cyclix_genvar;
	if (gen299_rtl_var)
		begin
		genmcopipe_coproc_M_if_wr_ptr = genmcopipe_coproc_M_if_wr_ptr_next;
		genmcopipe_coproc_M_if_empty_flag = 32'd0;
		gen943_cyclix_genvar = (genmcopipe_coproc_M_if_rd_ptr == genmcopipe_coproc_M_if_wr_ptr);
		gen944_cyclix_genvar = gen943_cyclix_genvar;
		gen300_rtl_var = gen944_cyclix_genvar;
		if (gen300_rtl_var)
			begin
			genmcopipe_coproc_M_if_full_flag = 32'd1;
			end
		end
	gen945_cyclix_genvar = genmcopipe_coproc_custom0_if_rd_done;
	gen301_rtl_var = gen945_cyclix_genvar;
	if (gen301_rtl_var)
		begin
		...
		gen302_rtl_var = gen947_cyclix_genvar;
		if (gen302_rtl_var)
			begin
			genmcopipe_coproc_custom0_if_empty_flag = 32'd1;
			end
		end
	gen948_cyclix_genvar = genmcopipe_coproc_custom0_if_wr_done;
	gen303_rtl_var = gen948_cyclix_genvar;
	if (gen303_rtl_var)
		begin
		...
		gen949_cyclix_genvar = (genmcopipe_coproc_custom0_if_rd_ptr == genmcopipe_coproc_custom0_if_wr_ptr);
		gen950_cyclix_genvar = gen949_cyclix_genvar;
		gen304_rtl_var = gen950_cyclix_genvar;
		if (gen304_rtl_var)
			begin
